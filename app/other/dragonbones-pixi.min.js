if (!window.egret) {
	var egret_strings = {
		...
		this.type = t, this.bubbles = i || !1, this.cancelable = e || !1, this.data = a
	}, EventDispatcher = function (t) {
		this._listenerDict = {}
	};
	EventDispatcher.prototype = {
		constructor: EventDispatcher, addEventListener: function (t, i, e, a, n, s) {
			this._listenerDict[t] || (this._listenerDict[t] = []), this._listenerDict[t].push({
				listener: i,
				thisObject: e,
				useCapture: a,
				priority: n,
			...
			if (t)if (i) {
				var n = this._listenerDict[t], s = n.indexOf(i);
				s > -1 && n.splice(s, 1)
			} else this._listenerDict[t] && (this._listenerDict[t].length = 0); else this._listenerDict = {}
		}, hasEventListener: function (t) {
			return this._listenerDict[t]
		}, dispatchEvent: function (t) {
			if (t && t.type && this._listenerDict[t.type])for (var i = this._listenerDict[t.type], e = i.slice(), a = 0; a < e.length; a++) {
				var n = e[a];
				if (n.dispatchOnce) {
					var s = i.indexOf(n);
					s > -1 && i.splice(s, 1), n.listener && n.listener.call(n.thisObject || this, t)
				}
			}
		...
		}, Event: Event, EventDispatcher: EventDispatcher, registerClass: function (t, i, e) {
			var a = t.prototype;
			a.__class__ = i;
			var n = [i];
			e && (n = n.concat(e));
			var s = a.__types__;
			if (a.__types__)for (var r = s.length, o = 0; r > o; o++) {
				var l = s[o];
...
window.__extends = window.__extends || function (t, i, e) {
		...
		if (a.prototype = i.prototype, t.prototype = new a, e)for (var s in e)t.prototype[s] = e[s]
	}, window.__define = window.__define || function (t, i, e, a) {
		Object.defineProperty(t, i, {configurable: !0, enumerable: !0, get: e, set: a})
	};
var dragonBones;
!function (t) {
	var i = function () {
		...
		var i = (__define, t);
		i.prototype;
		return t.DATA_VERSION = "4.0", t.PARENT_COORDINATE_DATA_VERSION = "3.0", t.VERSION = "4.3.5", t
	}();
...
!function (t) {
	var i = function () {
		...
		var e = __define, a = i, n = a.prototype;
		return n.dispose = function () {
			...
			for (var i, e = this._animationStateList.length; e--;)i = this._animationStateList[e], i._resetTimelineStateList(), t.AnimationState._returnObject(i);
			this._animationStateList.length = 0
		}, n.gotoAndPlay = function (e, a, n, s, r, o, l, h, _) {
			if (void 0 === a && (a = -1), void 0 === n && (n = -1), void 0 === s && (s = NaN), void 0 === r && (r = 0), void 0 === o && (o = null), void 0 === l && (l = i.SAME_LAYER_AND_GROUP), void 0 === h && (h = !0), void 0 === _ && (_ = !0), !this._animationDataList)return null;
			for (var u, m = this._animationDataList.length; m--;)if (this._animationDataList[m].name == e) {
				u = this._animationDataList[m];
				break
			}
			if (!u)return null;
			var f = 0 == this._isPlaying;
			this._isPlaying = !0, this._isFading = !0, a = 0 > a ? u.fadeTime < 0 ? .3 : u.fadeTime : a;
			var d;
			d = 0 > n ? u.scale < 0 ? 1 : u.scale : 1e3 * n / u.duration, s = isNaN(s) ? u.playTimes : s;
			var c;
			switch (l) {
				case i.NONE:
					break;
				case i.SAME_LAYER:
					for (m = this._animationStateList.length; m--;)c = this._animationStateList[m], c.layer == r && c.fadeOut(a, h);
					break;
				case i.SAME_GROUP:
					for (m = this._animationStateList.length; m--;)c = this._animationStateList[m], c.group == o && c.fadeOut(a, h);
					break;
				case i.ALL:
					for (m = this._animationStateList.length; m--;)c = this._animationStateList[m], c.fadeOut(a, h);
					break;
				case i.SAME_LAYER_AND_GROUP:
				default:
					for (m = this._animationStateList.length; m--;)c = this._animationStateList[m], c.layer == r && c.group == o && c.fadeOut(a, h)
			}
			this._lastAnimationState = t.AnimationState._borrowObject(), this._lastAnimationState._layer = r, this._lastAnimationState._group = o, this._lastAnimationState.autoTween = this.tweenEnabled, this._lastAnimationState._fadeIn(this._armature, u, a, 1 / d, s, _), this.addState(this._lastAnimationState);
			...
			void 0 === a && (a = -1), void 0 === n && (n = 0), void 0 === s && (s = -1), void 0 === r && (r = 0), void 0 === o && (o = null), void 0 === l && (l = i.ALL);
			var h = this.getState(t, r);
			return h || (h = this.gotoAndPlay(t, n, s, NaN, r, o, l)), a >= 0 ? h.setCurrentTime(h.totalTime * a) : h.setCurrentTime(e), h.stop(), h
		}, n.play = function () {
			...
			for (var e = this._animationStateList.length; e--;) {
				...
				if (a.name == t && a.layer == i)return a
			}
			return null
		}, n.hasAnimation = function (t) {
			for (var i = this._animationDataList.length; i--;)if (this._animationDataList[i].name == t)return !0;
			return !1
			...
			e >= 0 && (this._animationStateList.splice(e, 1), t.AnimationState._returnObject(i), this._lastAnimationState == i && (this._animationStateList.length > 0 ? this._lastAnimationState = this._animationStateList[0] : this._lastAnimationState = null), this._animationStateCount = this._animationStateList.length)
		...
		}), i.NONE = "none", i.SAME_LAYER = "sameLayer", i.SAME_GROUP = "sameGroup", i.SAME_LAYER_AND_GROUP = "sameLayerAndGroup", i.ALL = "all", i
	}();
	t.Animation = i, egret.registerClass(i, "dragonBones.Animation")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return i._borrowObject = function () {
			...
			t.clear(), i._pool.indexOf(t) < 0 && (i._pool[i._pool.length] = t)
		}, i._clear = function () {
			for (var e = i._pool.length; e--;)i._pool[e].clear();
			i._pool.length = 0, t.TimelineState._clear()
		}, n.clear = function () {
			...
			for (var i = this._timelineStateList.length; i--;)t.TimelineState._returnObject(this._timelineStateList[i]);
			for (this._timelineStateList.length = 0, i = this._slotTimelineStateList.length; i--;)t.SlotTimelineState._returnObject(this._slotTimelineStateList[i]);
			...
			if (void 0 === i && (i = !0), this.addBoneToBoneMask(t), i) {
				var e = this._armature.getBone(t);
				if (e)for (var a = this._armature.getBones(!1), n = a.length; n--;) {
					var s = a[n];
			...
			if (void 0 === i && (i = !0), this.removeBoneFromBoneMask(t), i) {
				var e = this._armature.getBone(t);
				if (e)for (var a = this._armature.getBones(!1), n = a.length; n--;) {
					var s = a[n];
			...
			for (var t, i, e, a = this._timelineStateList.length; a--;)t = this._timelineStateList[a], this._armature.getBone(t.name) || this.removeTimelineState(t);
			for (a = this._slotTimelineStateList.length; a--;)i = this._slotTimelineStateList[a], this._armature.getSlot(i.name) || this.removeSlotTimelineState(i);
			if (this._boneMasks.length > 0) {
				for (a = this._timelineStateList.length; a--;)t = this._timelineStateList[a], this._boneMasks.indexOf(t.name) < 0 && this.removeTimelineState(t);
				for (a = 0, e = this._boneMasks.length; e > a; a++) {
					var n = this._boneMasks[a];
					this.addTimelineState(n)
				}
			} else for (a = 0, e = this._clip.timelineList.length; e > a; a++) {
				var s = this._clip.timelineList[a];
				this.addTimelineState(s.name)
			}
			for (a = 0, e = this._clip.slotTimelineList.length; e > a; a++) {
			...
			if (e) {
				...
				r._fadeIn(e, this, this._clip.getTimeline(i)), this._timelineStateList.push(r)
			}
		}, n.removeTimelineState = function (i) {
			var e = this._timelineStateList.indexOf(i);
			this._timelineStateList.splice(e, 1), t.TimelineState._returnObject(i)
			...
			var s;
			e && (this._isFadeOut ? this._armature.hasEventListener(t.AnimationEvent.FADE_OUT) && (s = new t.AnimationEvent(t.AnimationEvent.FADE_OUT), s.animationState = this, this._armature._eventList.push(s)) : (this.hideBones(), this._armature.hasEventListener(t.AnimationEvent.FADE_IN) && (s = new t.AnimationEvent(t.AnimationEvent.FADE_IN), s.animationState = this, this._armature._eventList.push(s)))), a && (this._isFadeOut ? this._armature.hasEventListener(t.AnimationEvent.FADE_OUT_COMPLETE) && (s = new t.AnimationEvent(t.AnimationEvent.FADE_OUT_COMPLETE), s.animationState = this, this._armature._eventList.push(s)) : this._armature.hasEventListener(t.AnimationEvent.FADE_IN_COMPLETE) && (s = new t.AnimationEvent(t.AnimationEvent.FADE_IN_COMPLETE), s.animationState = this, this._armature._eventList.push(s)))
		}, n.advanceTimelinesTime = function (i) {
			this._isPlaying && !this._pausePlayheadInFade && (this._time += i);
			var e = !1, a = !1, n = !1, s = !1, r = 0, o = 1e3 * this._time;
			if (0 == this._playTimes)s = !1, r = Math.ceil(Math.abs(o) / this._totalTime) || 1, o -= o >= 0 ? Math.floor(o / this._totalTime) * this._totalTime : Math.ceil(o / this._totalTime) * this._totalTime, 0 > o && (o += this._totalTime); else {
				var l = this._playTimes * this._totalTime;
				o >= l ? (o = l, s = !0) : -l >= o ? (o = -l, s = !0) : s = !1, 0 > o && (o += l), r = Math.ceil(o / this._totalTime) || 1, o -= o >= 0 ? Math.floor(o / this._totalTime) * this._totalTime : Math.ceil(o / this._totalTime) * this._totalTime, s && (o = this._totalTime)
			}
			this._isComplete = s;
			var h = 1e3 * this._time / this._totalTime, _ = 0, u = 0;
			for (_ = 0, u = this._timelineStateList.length; u > _; _++) {
				var m = this._timelineStateList[_];
				m._update(h), this._isComplete = m._isComplete && this._isComplete
			}
			for (_ = 0, u = this._slotTimelineStateList.length; u > _; _++) {
				var f = this._slotTimelineStateList[_];
				f._update(h), this._isComplete = m._isComplete && this._isComplete
			}
			this._currentTime != o && (this._currentPlayTimes != r && (this._currentPlayTimes > 0 && r > 1 && (n = !0), this._currentPlayTimes = r), this._currentTime < 0 && (e = !0), this._isComplete && (a = !0), this._lastTime = this._currentTime, this._currentTime = o, this.updateMainTimeline(s));
			var d;
			e && this._armature.hasEventListener(t.AnimationEvent.START) && (d = new t.AnimationEvent(t.AnimationEvent.START), d.animationState = this, this._armature._eventList.push(d)), a ? (this._armature.hasEventListener(t.AnimationEvent.COMPLETE) && (d = new t.AnimationEvent(t.AnimationEvent.COMPLETE), d.animationState = this, this._armature._eventList.push(d)), this.autoFadeOut && this.fadeOut(this.fadeOutTime, !0)) : n && this._armature.hasEventListener(t.AnimationEvent.LOOP_COMPLETE) && (d = new t.AnimationEvent(t.AnimationEvent.LOOP_COMPLETE), d.animationState = this, this._armature._eventList.push(d))
			...
			if (i.length > 0) {
				for (var e, a, n = 0, s = this._clip.frameList.length; s > n; ++n) {
					if (this._currentFrameIndex < 0)this._currentFrameIndex = 0; else {
						...
						if (this._currentFrameIndex++, this._lastTime = this._currentTime, this._currentFrameIndex >= i.length) {
							if (t) {
					...
					a = i[this._currentFrameIndex], e && this._armature._arriveAtFrame(e, null, this, !0), this._currentFrameDuration = a.duration, this._currentFramePosition = a.position, e = a
				}
			...
			for (var t = 0, i = this._clip.hideTimelineNameMap.length; i > t; t++) {
				var e = this._clip.hideTimelineNameMap[t], a = this._armature.getBone(e);
				a && a._hideSlots()
			}
			var n;
			for (t = 0, i = this._clip.hideSlotTimelineNameMap.length; i > t; t++) {
			...
			return void 0 === i && (i = -1), this.autoFadeOut = t, i >= 0 && (this.fadeOutTime = i * this._timeScale), this
		}, n.setWeight = function (t) {
			return (isNaN(t) || 0 > t) && (t = 1), this.weight = t, this
		}, n.setFrameTween = function (t, i) {
			return this.autoTween = t, this.lastFrameAutoTween = i, this
			...
			return void 0 === t && (t = 0), Math.round(.001 * this._totalTime * this._clip.frameRate) < 2 ? this._playTimes = 0 > t ? -1 : 1 : this._playTimes = 0 > t ? -t : t, this.autoFadeOut = 0 > t ? !0 : !1, this
		}, e(n, "name", function () {
			return this._name
		}), e(n, "layer", function () {
			return this._layer
	...
	t.AnimationState = i, egret.registerClass(i, "dragonBones.AnimationState")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		var e = (__define, i), a = e.prototype;
		return i._borrowObject = function () {
			return 0 == i._pool.length ? new i : i._pool.pop()
		}, i._returnObject = function (t) {
			i._pool.indexOf(t) < 0 && (i._pool[i._pool.length] = t), t.clear()
		}, i._clear = function () {
			for (var t = i._pool.length; t--;)i._pool[t].clear();
			i._pool.length = 0
		}, a.clear = function () {
			...
			var e = this._totalTime * t, a = this._animationState.playTimes;
			if (0 == a)this._isComplete = !1, i = Math.ceil(Math.abs(e) / this._totalTime) || 1, e -= e >= 0 ? Math.floor(e / this._totalTime) * this._totalTime : Math.ceil(e / this._totalTime) * this._totalTime, 0 > e && (e += this._totalTime); else {
				var n = a * this._totalTime;
				e >= n ? (e = n, this._isComplete = !0) : -n >= e ? (e = -n, this._isComplete = !0) : this._isComplete = !1, 0 > e && (e += n), i = Math.ceil(e / this._totalTime) || 1, this._isComplete ? e = this._totalTime : e -= e >= 0 ? Math.floor(e / this._totalTime) * this._totalTime : Math.ceil(e / this._totalTime) * this._totalTime
			}
			if (this._currentTime != e) {
				...
				for (var s, r, o = this._timelineData.frameList, l = 0, h = this._timelineData.frameList.length; h > l; ++l) {
					...
					r = o[this._currentFrameIndex], s && this._slot._arriveAtFrame(s, this, this._animationState, !0), this._currentFrameDuration = r.duration, this._currentFramePosition = r.position, s = r
				}
				r && (this._slot._arriveAtFrame(r, this, this._animationState, !1), this._blendEnabled = r.displayIndex >= 0, this._blendEnabled ? this.updateToNextFrame(i) : (this._tweenEasing = NaN, this._tweenColor = !1)), this._blendEnabled && this.updateTween()
			}
		}, a.updateToNextFrame = function (t) {
			void 0 === t && (t = 0);
			var i = this._currentFrameIndex + 1;
			i >= this._timelineData.frameList.length && (i = 0);
			var e = this._timelineData.frameList[this._currentFrameIndex], a = this._timelineData.frameList[i], n = !1;
			...
			if (this._tweenColor && this._animationState.displayControl) {
				...
				null != this._tweenCurve ? e = this._tweenCurve.getValueByProgress(e) : this._tweenEasing && (e = t.MathUtil.getEaseValue(e, this._tweenEasing)), i.color ? this._slot._updateDisplayColor(i.color.alphaOffset + this._durationColor.alphaOffset * e, i.color.redOffset + this._durationColor.redOffset * e, i.color.greenOffset + this._durationColor.greenOffset * e, i.color.blueOffset + this._durationColor.blueOffset * e, i.color.alphaMultiplier + this._durationColor.alphaMultiplier * e, i.color.redMultiplier + this._durationColor.redMultiplier * e, i.color.greenMultiplier + this._durationColor.greenMultiplier * e, i.color.blueMultiplier + this._durationColor.blueMultiplier * e, !0) : this._slot._updateDisplayColor(this._durationColor.alphaOffset * e, this._durationColor.redOffset * e, this._durationColor.greenOffset * e, this._durationColor.blueOffset * e, 1 + this._durationColor.alphaMultiplier * e, 1 + this._durationColor.redMultiplier * e, 1 + this._durationColor.greenMultiplier * e, 1 + this._durationColor.blueMultiplier * e, !0)
			}
		...
		}, i.HALF_PI = .5 * Math.PI, i.DOUBLE_PI = 2 * Math.PI, i._pool = [], i
	}();
	t.SlotTimelineState = i, egret.registerClass(i, "dragonBones.SlotTimelineState")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return i._borrowObject = function () {
			...
			if (this._currentTime != e) {
				this._lastTime = this._currentTime, this._currentTime = e;
				for (var s, r, o = this._timelineData.frameList, l = 0, h = this._timelineData.frameList.length; h > l; ++l) {
					if (this._currentFrameIndex < 0)this._currentFrameIndex = 0; else {
						if (!(this._currentTime < this._currentFramePosition || this._currentTime >= this._currentFramePosition + this._currentFrameDuration || this._currentTime < this._lastTime))break;
					...
					r = o[this._currentFrameIndex], s && this._bone._arriveAtFrame(s, this, this._animationState, !0), this._currentFrameDuration = r.duration, this._currentFramePosition = r.position, s = r
				}
				r && (this._bone._arriveAtFrame(r, this, this._animationState, !1), this.updateToNextFrame(i)), this.updateTween()
			}
		}, a.updateToNextFrame = function (i) {
			void 0 === i && (i = 0);
			var e = this._currentFrameIndex + 1;
			e >= this._timelineData.frameList.length && (e = 0);
			var a = this._timelineData.frameList[this._currentFrameIndex], n = this._timelineData.frameList[e], s = !1;
	...
	t.TimelineState = i, egret.registerClass(i, "dragonBones.TimelineState")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		function t(t, i) {
			void 0 === t && (t = -1), void 0 === i && (i = 1), this._time = t >= 0 ? t : .001 * (new Date).getTime(), this._timeScale = isNaN(i) ? 1 : i, this._animatableList = []
		}

		var i = __define, e = t, a = e.prototype;
		return i(a, "time", function () {
			...
			void 0 === t && (t = -1), 0 > t && (t = .001 * (new Date).getTime() - this._time), t *= this._timeScale, this._time += t;
			var i = this._animatableList.length;
			if (0 != i) {
				for (var e = 0, a = 0; i > a; a++) {
					var n = this._animatableList[a];
					n && (e != a && (this._animatableList[e] = n, this._animatableList[a] = null), n.advanceTime(t), e++)
				}
				if (e != a) {
					for (i = this._animatableList.length; i > a;)this._animatableList[e++] = this._animatableList[a++];
					this._animatableList.length = e
				}
			}
		}, t.clock = new t, t
	}();
	t.WorldClock = i, egret.registerClass(i, "dragonBones.WorldClock", ["dragonBones.IAnimatable"])
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (t) {
		function i(i) {
			void 0 === i && (i = null), t.call(this, i)
		}
	...
	t.EventDispatcher = i, egret.registerClass(i, "dragonBones.EventDispatcher")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (t) {
		function i() {
			if (t.call(this), i._instance)throw new Error("Singleton already constructed!")
		}
	...
	t.SoundEventManager = i, egret.registerClass(i, "dragonBones.SoundEventManager")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (i) {
		function e(e) {
			i.call(this), this._display = e, this._animation = new t.Animation(this), this._slotsZOrderChanged = !1, this._slotList = [], this._boneList = [], this._eventList = [], this._delayDispose = !1, this._lockDispose = !1, this._armatureData = null
		}

		__extends(e, i);
		var a = __define, n = e, s = n.prototype;
		return a(s, "armatureData", function () {
			...
			if (this._delayDispose = !0, this._animation && !this._lockDispose) {
				...
				this._armatureData = null, this._animation = null, this._slotList = null, this._boneList = null, this._eventList = null
			}
		}, s.invalidUpdate = function (t) {
			if (void 0 === t && (t = null), t) {
				var i = this.getBone(t);
				i && i.invalidUpdate()
			} else for (var e = this._boneList.length; e--;)this._boneList[e].invalidUpdate()
		}, s.advanceTime = function (i) {
			this._lockDispose = !0, this._animation._advanceTime(i), i *= this._animation.timeScale;
			...
			for (var t = 0, i = this._boneList.length; i > t; t++)this._boneList[t]._removeAllStates()
			...
			if (t)for (var i = this._slotList.length, e = 0; i > e; e++) {
				var a = this._slotList[e];
			...
			var a;
			if (i && (a = this.getBone(i), !a))throw new Error;
			a ? a.addChildBone(t, e) : (t.parent && t.parent.removeChildBone(t, e), t._setArmature(this), e || this._updateAnimationAfterBoneListChanged())
		}, s.removeBone = function (t, i) {
			if (void 0 === i && (i = !1), !t || t.armature != this)throw new Error;
			t.parent ? t.parent.removeChildBone(t, i) : (t._setArmature(null), i || this._updateAnimationAfterBoneListChanged(!1))
		}, s.removeBoneByName = function (t) {
			var i = this.getBone(t);
			return i && this.removeBone(i), i
			...
			if (0 != i) {
				for (var e = []; i--;) {
					for (var a = 0, n = this._boneList[i], s = n; s;)a++, s = s.parent;
					e[i] = [a, n]
				}
				for (e.sort(t.ArmatureData.sortBoneDataHelpArrayDescending), i = e.length; i--;)this._boneList[i] = e[i][1];
				e.length = 0
			}
			...
			if (i.event && this.hasEventListener(t.FrameEvent.ANIMATION_FRAME_EVENT)) {
				...
				r.animationState = n, r.frameLabel = i.event, this._eventList.push(r)
			}
			if (i.sound && e._soundManager.hasEventListener(t.SoundEvent.SOUND)) {
				var o = new t.SoundEvent(t.SoundEvent.SOUND);
				o.armature = this, o.animationState = n, o.sound = i.sound, e._soundManager.dispatchEvent(o)
			}
			...
			return this._animation
		}, e._soundManager = t.SoundEventManager.getInstance(), e
	}(t.EventDispatcher);
	t.Armature = i, egret.registerClass(i, "dragonBones.Armature", ["dragonBones.IAnimatable"])
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		var i = (__define, t), e = i.prototype;
		return e.invert = function () {
			var t = this.a, i = this.b, e = this.c, a = this.d, n = this.tx, s = t * a - i * e;
			this.a = a / s, this.b = -i / s, this.c = -e / s, this.d = t / s, this.tx = (e * this.ty - a * n) / s, this.ty = -(t * this.ty - i * n) / s
		}, e.concat = function (t) {
			var i = t.a, e = t.b, a = t.c, n = t.d, s = this.tx, r = this.ty;
			if (1 != i || 0 != e || 0 != a || 1 != n) {
				var o = this.a, l = this.b, h = this.c, _ = this.d;
				this.a = o * i + l * a, this.b = o * e + l * n, this.c = h * i + _ * a, this.d = h * e + _ * n
			}
			this.tx = s * i + r * a + t.tx, this.ty = s * e + r * n + t.ty
		}, e.copyFrom = function (t) {
			this.tx = t.tx, this.ty = t.ty, this.a = t.a, this.b = t.b, this.c = t.c, this.d = t.d
		}, t
	}();
	t.Matrix = i, egret.registerClass(i, "dragonBones.Matrix")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
	...
	t.DBTransform = i, egret.registerClass(i, "dragonBones.DBTransform")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return e(n, "global", function () {
			...
			if (this.parent && (this.inheritTranslation || this.inheritRotation || this.inheritScale)) {
				var e = this._parent._globalTransformForChild, a = this._parent._globalTransformMatrixForChild;
				return this.inheritTranslation && this.inheritRotation && this.inheritScale || (e = i._tempParentGlobalTransform, e.copy(this._parent._globalTransformForChild), this.inheritTranslation || (e.x = 0, e.y = 0), this.inheritScale || (e.scaleX = 1, e.scaleY = 1), this.inheritRotation || (e.skewX = 0, e.skewY = 0), a = i._tempParentGlobalTransformMatrix, t.TransformUtil.transformToMatrix(e, a, !0)), {
			...
			if (null != i) {
				var e = i.parentGlobalTransformMatrix, a = i.parentGlobalTransform, n = this._global.x, s = this._global.y;
				this._global.x = e.a * n + e.c * s + e.tx, this._global.y = e.d * s + e.b * n + e.ty, this.inheritRotation && (this._global.skewX += a.skewX, this._global.skewY += a.skewY), this.inheritScale && (this._global.scaleX *= a.scaleX, this._global.scaleY *= a.scaleY)
			}
			return t.TransformUtil.transformToMatrix(this._global, this._globalTransformMatrix, !0), i
		}, i._tempParentGlobalTransformMatrix = new t.Matrix, i._tempParentGlobalTransform = new t.DBTransform, i
	}();
	t.DBObject = i, egret.registerClass(i, "dragonBones.DBObject")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (i) {
		function e() {
			i.call(this), this.applyOffsetTranslationToChild = !0, this.applyOffsetRotationToChild = !0, this.applyOffsetScaleToChild = !1, this._needUpdate = 0, this._tween = new t.DBTransform, this._tweenPivot = new t.Point, this._tween.scaleX = this._tween.scaleY = 1, this._boneList = [], this._slotList = [], this._timelineStateList = [], this._needUpdate = 2, this._isColorChanged = !1
		}
		...
		return e.initWithBoneData = function (t) {
			var i = new e;
			return i.name = t.name, i.inheritRotation = t.inheritRotation, i.inheritScale = t.inheritScale, i.origin.copy(t.transform), i
		}, s.dispose = function () {
			if (this._boneList) {
			...
			if (t == this)return !1;
			for (var i = t; i != this && null != i;)i = i.parent;
			return i == this
		}, s.addChildBone = function (t, i) {
			if (void 0 === i && (i = !1), !t)throw new Error;
			if (t == this || t.contains(this))throw new Error;
			t.parent != this && (t.parent && t.parent.removeChildBone(t, i), this._boneList[this._boneList.length] = t, t._setParent(this), t._setArmature(this._armature), this._armature && !i && this._armature._updateAnimationAfterBoneListChanged())
		}, s.removeChildBone = function (t, i) {
			if (void 0 === i && (i = !1), !t)throw new Error;
			var e = this._boneList.indexOf(t);
			if (0 > e)throw new Error;
			this._boneList.splice(e, 1), t._setParent(null), t._setArmature(null), this._armature && !i && this._armature._updateAnimationAfterBoneListChanged(!1)
			...
			this._slotList.splice(i, 1), t._setParent(null), t.setArmature(null)
			...
			if (this._armature != t) {
				...
				for (var i = this._boneList.length; i--;)this._boneList[i]._setArmature(this._armature);
				for (i = this._slotList.length; i--;)this._slotList[i].setArmature(this._armature)
			}
		}, s.getBones = function (t) {
			return void 0 === t && (t = !0), t ? this._boneList.concat() : this._boneList
		}, s.getSlots = function (t) {
			...
			if (r) {
				...
				if (i.event && this._armature.hasEventListener(t.FrameEvent.BONE_FRAME_EVENT)) {
					...
					h.bone = this, h.animationState = n, h.frameLabel = i.event, this._armature._eventList.push(h)
				}
				if (i.sound && e._soundManager.hasEventListener(t.SoundEvent.SOUND)) {
					var _ = new t.SoundEvent(t.SoundEvent.SOUND);
					_.armature = this._armature, _.animationState = n, _.sound = i.sound, e._soundManager.dispatchEvent(_)
				}
				if (i.action)for (var u = this._slotList.length, m = 0; u > m; m++) {
					o = this._slotList[m];
			...
			if (1 == n)t = this._timelineStateList[0], a = t._animationState.weight * t._animationState.fadeWeight, t._weight = a, i = t._transform, e = t._pivot, this._tween.x = i.x * a, this._tween.y = i.y * a, this._tween.skewX = i.skewX * a, this._tween.skewY = i.skewY * a, this._tween.scaleX = 1 + (i.scaleX - 1) * a, this._tween.scaleY = 1 + (i.scaleY - 1) * a, this._tweenPivot.x = e.x * a, this._tweenPivot.y = e.y * a; else if (n > 1) {
				for (var s = 0, r = 0, o = 0, l = 0, h = 1, _ = 1, u = 0, m = 0, f = 1, d = 0, c = this._timelineStateList[n - 1]._animationState.layer, p = 0; n--;) {
					...
					c = p, a = t._animationState.weight * t._animationState.fadeWeight * f, t._weight = a, a && (i = t._transform, e = t._pivot, s += i.x * a, r += i.y * a, o += i.skewX * a, l += i.skewY * a, h += (i.scaleX - 1) * a, _ += (i.scaleY - 1) * a, u += e.x * a, m += e.y * a, d += a)
				}
				this._tween.x = s, this._tween.y = r, this._tween.skewX = o, this._tween.skewY = l, this._tween.scaleX = h, this._tween.scaleY = _, this._tweenPivot.x = u, this._tweenPivot.y = m
			}
	...
	t.Bone = i, egret.registerClass(i, "dragonBones.Bone")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (i) {
		function e(e) {
			if (i.call(this), this._currentDisplayIndex = 0, e != this)throw new Error(egret.getString(4001));
			this._displayList = [], this._timelineStateList = [], this._currentDisplayIndex = -1, this._originZOrder = 0, this._tweenZOrder = 0, this._offsetZOrder = 0, this._isShowDisplay = !1, this._colorTransform = new t.ColorTransform, this._displayDataList = null, this._currentDisplay = null, this.inheritRotation = !0, this.inheritScale = !0
		}

		__extends(e, i);
		var a = __define, n = e, s = n.prototype;
		return s.initWithSlotData = function (t) {
			this.name = t.name, this.blendMode = t.blendMode, this._originZOrder = t.zOrder, this._displayDataList = t.displayDataList, this._originDisplayIndex = t.displayIndex
		}, s.dispose = function () {
			this._displayList && (i.prototype.dispose.call(this), this._displayList.length = 0, this._displayDataList = null, this._displayList = null, this._currentDisplay = null)
		}, s.sortState = function (t, i) {
			return t._animationState.layer < i._animationState.layer ? -1 : 1
		}, s._addState = function (t) {
			this._timelineStateList.indexOf(t) < 0 && (this._timelineStateList.push(t), this._timelineStateList.sort(this.sortState))
			...
			this._parent._needUpdate <= 0 && !this._needUpdate || (this._updateGlobal(), this._updateTransform(), this._needUpdate = !1)
		}, s._calculateRelativeParentTransform = function () {
			...
			this.childArmature && (this._isShowDisplay ? this._armature && this._armature.animation.lastAnimationState && this.childArmature.animation.hasAnimation(this._armature.animation.lastAnimationState.name) ? this.childArmature.animation.gotoAndPlay(this._armature.animation.lastAnimationState.name) : this.childArmature.animation.play() : (this.childArmature.animation.stop(), this.childArmature.animation._lastAnimationState = null))
			...
			if (void 0 === t && (t = 0), 0 > t)this._isShowDisplay && (this._isShowDisplay = !1, this._removeDisplayFromContainer(), this.updateChildArmatureAnimation()); else if (this._displayList.length > 0) {
				...
				t >= i && (t = i - 1), this._currentDisplayIndex != t ? (this._isShowDisplay = !0, this._currentDisplayIndex = t, this._updateSlotDisplay(), this.updateChildArmatureAnimation(), this._displayDataList && this._displayDataList.length > 0 && this._currentDisplayIndex < this._displayDataList.length && this._origin.copy(this._displayDataList[this._currentDisplayIndex].transform), this._needUpdate = !0) : this._isShowDisplay || (this._isShowDisplay = !0, this._armature && (this._armature._slotsZOrderChanged = !0, this._addDisplayToContainer(this._armature.display)), this.updateChildArmatureAnimation())
			}
		}, s._updateSlotDisplay = function () {
			var i = -1;
			this._currentDisplay && (i = this._getDisplayIndex(), this._removeDisplayFromContainer());
			var e = this._displayList[this._currentDisplayIndex];
			e ? e instanceof t.Armature ? this._currentDisplay = e.display : this._currentDisplay = e : this._currentDisplay = null, this._updateDisplay(this._currentDisplay), this._currentDisplay && (this._armature && this._isShowDisplay && (0 > i ? (this._armature._slotsZOrderChanged = !0, this._addDisplayToContainer(this._armature.display)) : this._addDisplayToContainer(this._armature.display, i)), this._updateDisplayBlendMode(this._blendMode), this._updateDisplayColor(this._colorTransform.alphaOffset, this._colorTransform.redOffset, this._colorTransform.greenOffset, this._colorTransform.blueOffset, this._colorTransform.alphaMultiplier, this._colorTransform.redMultiplier, this._colorTransform.greenMultiplier, this._colorTransform.blueMultiplier, !0), this._updateDisplayVisible(this._visible), this._updateTransform())
		}, a(s, "visible", void 0, function (t) {
			...
			for (var i = this._displayList.length = t.length; i--;)this._displayList[i] = t[i];
			var e = this._currentDisplayIndex;
			this._currentDisplayIndex = -1, this._changeDisplay(e)
		}), a(s, "display", function () {
			...
			throw void 0 === i && (i = -1), new Error(egret.getString(4001))
			...
			void 0 === l && (l = !1), this._colorTransform.alphaOffset = t, this._colorTransform.redOffset = i, this._colorTransform.greenOffset = e, this._colorTransform.blueOffset = a, this._colorTransform.alphaMultiplier = n, this._colorTransform.redMultiplier = s, this._colorTransform.greenMultiplier = r, this._colorTransform.blueMultiplier = o, this._isColorChanged = l
			...
			if (n) {
				var s = t, r = s.displayIndex;
				this._changeDisplay(r), this._updateDisplayVisible(s.visible), r >= 0 && (isNaN(s.zOrder) || s.zOrder == this._tweenZOrder || (this._tweenZOrder = s.zOrder, this._armature._slotsZOrderChanged = !0)), t.action && this.childArmature && this.childArmature.animation.gotoAndPlay(t.action)
			}
		}, s._updateGlobal = function () {
			this._calculateRelativeParentTransform(), t.TransformUtil.transformToMatrix(this._global, this._globalTransformMatrix, !0);
			var i = this._calculateParentTransform();
			return i && (this._globalTransformMatrix.concat(i.parentGlobalTransformMatrix), t.TransformUtil.matrixToTransform(this._globalTransformMatrix, this._global, this._global.scaleX * i.parentGlobalTransform.scaleX >= 0, this._global.scaleY * i.parentGlobalTransform.scaleY >= 0)), i
		}, s._resetToOrigin = function () {
			this._changeDisplay(this._originDisplayIndex), this._updateDisplayColor(0, 0, 0, 0, 1, 1, 1, 1, !0);
		}, e
	}(t.DBObject);
	t.Slot = i, egret.registerClass(i, "dragonBones.Slot")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return i.initWithAnimationData = function (e, a) {
			...
			for (var s, r, o, l, h = e.timelineList, _ = 0, u = h.length; u > _; _++) {
				s = h[_].name;
				for (var m = 0, f = a.slotDataList.length; f > m; m++)r = a.slotDataList[m], l = r.name, r.parent == s && null == n.slotTimelineCacheDic[l] && (o = new t.SlotTimelineCache, o.name = l, n.slotTimelineCacheList.push(o), n.slotTimelineCacheDic[l] = o)
			}
			return n
			...
			for (var a in this.slotTimelineCacheDic) {
				...
				e = n.name, n.cacheGenerator = t[e], n.currentFrameCache = i[e]
			}
		}, a.bindCacheUserSlotDic = function (t) {
			for (var i in t)this.slotTimelineCacheDic[i].bindCacheUser(t[i])
		}, a.addFrame = function () {
			this.frameNum++;
			for (var t, i = 0, e = this.slotTimelineCacheList.length; e > i; i++)t = this.slotTimelineCacheList[i], t.addFrame()
		}, a.update = function (t) {
			for (var i, e = Math.floor(t * (this.frameNum - 1)), a = 0, n = this.slotTimelineCacheList.length; n > a; a++)i = this.slotTimelineCacheList[a], i.update(e)
		}, i
	}();
	t.AnimationCache = i, egret.registerClass(i, "dragonBones.AnimationCache")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return i.initWithArmatureData = function (t, e) {
			...
			var i;
			for (var e in t._slotDic)i = t._slotDic[e], i.frameCache = this.slotFrameCacheDic[i.name]
		}, a.setCacheGeneratorArmature = function (i) {
			this.cacheGeneratorArmature = i;
			var e;
			for (var a in i._slotDic)e = i._slotDic[a], this.slotFrameCacheDic[e.name] = new t.SlotFrameCache;
			...
			if (a) {
				var n = this.cacheGeneratorArmature.getAnimation().animationState, s = 1 / this.frameRate;
				...
				var o;
				do o = n.progress, this.cacheGeneratorArmature.advanceTime(s), a.addFrame(); while (n.progress >= o && n.progress < 1);
				this.cacheGeneratorArmature.enableEventDispatch = r, this.resetCacheGeneratorArmature(), this.cacheGeneratorArmature.enableCache = e
			}
	...
	t.AnimationCacheManager = i, egret.registerClass(i, "dragonBones.AnimationCacheManager")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return a.copy = function (t) {
			...
			this.globalTransform = i.ORIGIN_TRAMSFORM, this.globalTransformMatrix = i.ORIGIN_MATRIX
		}, i.ORIGIN_TRAMSFORM = new t.DBTransform, i.ORIGIN_MATRIX = new t.Matrix, i
	}();
	t.FrameCache = i, egret.registerClass(i, "dragonBones.FrameCache")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (t) {
		...
		return a.copy = function (i) {
			t.prototype.copy.call(this, i), this.colorTransform = i.colorTransform, this.displayIndex = i.displayIndex
		}, a.clear = function () {
			t.prototype.clear.call(this), this.colorTransform = null, this.displayIndex = -1
		}, i
	}(t.FrameCache);
	t.SlotFrameCache = i, egret.registerClass(i, "dragonBones.SlotFrameCache")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
	...
	t.TimelineCache = i, egret.registerClass(i, "dragonBones.TimelineCache")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (i) {
		...
		__extends(e, i);
		var a = (__define, e), n = a.prototype;
		return n.addFrame = function () {
			var i = new t.SlotFrameCache;
			i.globalTransform.copy(this.cacheGenerator.global), i.globalTransformMatrix.copyFrom(this.cacheGenerator.globalTransformMatrix), this.cacheGenerator.colorChanged && (i.colorTransform = t.ColorTransformUtil.cloneColor(this.cacheGenerator.colorTransform)), i.displayIndex = this.cacheGenerator.displayIndex, this.frameCacheList.push(i)
		}, e
	}(t.TimelineCache);
	t.SlotTimelineCache = i, egret.registerClass(i, "dragonBones.SlotTimelineCache")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (t) {
		function i(i, e, a) {
			void 0 === e && (e = !1), void 0 === a && (a = !1), t.call(this, i, e, a)
		}
	...
	t.Event = i, egret.registerClass(i, "dragonBones.Event")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (t) {
		function i(i, e) {
			void 0 === e && (e = !1), t.call(this, i)
		}
		...
		}), i.FADE_IN = "fadeIn", i.FADE_OUT = "fadeOut", i.START = "start", i.COMPLETE = "complete", i.LOOP_COMPLETE = "loopComplete", i.FADE_IN_COMPLETE = "fadeInComplete", i.FADE_OUT_COMPLETE = "fadeOutComplete", i
	}(t.Event);
	t.AnimationEvent = i, egret.registerClass(i, "dragonBones.AnimationEvent")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (t) {
		...
		var e = (__define, i);
		e.prototype;
		return i.Z_ORDER_UPDATED = "zOrderUpdated", i
	}(t.Event);
	t.ArmatureEvent = i, egret.registerClass(i, "dragonBones.ArmatureEvent")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (t) {
		...
		return e(i, "MOVEMENT_FRAME_EVENT", function () {
			...
			return this.target
		}), i.ANIMATION_FRAME_EVENT = "animationFrameEvent", i.BONE_FRAME_EVENT = "boneFrameEvent", i
	}(t.Event);
	t.FrameEvent = i, egret.registerClass(i, "dragonBones.FrameEvent")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (t) {
		...
		var e = (__define, i);
		e.prototype;
		return i.SOUND = "sound", i
	}(t.Event);
	t.SoundEvent = i, egret.registerClass(i, "dragonBones.SoundEvent")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (i) {
		function a(t) {
			if (i.call(this), this.dragonBonesDataDic = {}, this.textureAtlasDic = {}, t != this)throw new Error(egret.getString(4001))
		}

		__extends(a, i);
		var n = (__define, a), s = n.prototype;
		return s.dispose = function (t) {
			if (void 0 === t && (t = !0), t) {
				for (var i in this.dragonBonesDataDic)this.dragonBonesDataDic[i].dispose(), delete this.dragonBonesDataDic[i];
				for (var e in this.textureAtlasDic) {
					var a = this.textureAtlasDic[e];
					if (a)for (var n = 0, s = a.length; s > n; n++)a[n].dispose();
			...
			if (i = i || t.name, !i)throw new Error(egret.getString(4002));
			this.dragonBonesDataDic[i] = t
		}, s.addSkeletonData = function (t, i) {
			void 0 === i && (i = null), this.addDragonBonesData(t, i)
			...
			if (void 0 === i && (i = null), !t)throw new Error;
			if (!i && t.hasOwnProperty("name") && (i = t.name), !i)throw new Error(egret.getString(4002));
			var e = this.textureAtlasDic[i];
			null == e && (e = [], this.textureAtlasDic[i] = e), -1 == e.indexOf(t) && e.push(t)
		}, s.removeTextureAtlas = function (t) {
			delete this.textureAtlasDic[t]
		}, s.getTextureDisplay = function (t, i, e, a) {
			void 0 === i && (i = null), void 0 === e && (e = NaN), void 0 === a && (a = NaN);
			var n, s, r, o;
			if (i) {
				if (s = this.textureAtlasDic[i])for (r = 0, o = s.length; o > r && (n = s[r], !n.getRegion(t)); r++)n = null
			} else for (i in this.textureAtlasDic)if (s = this.textureAtlasDic[i]) {
				for (r = 0, o = s.length; o > r && (n = s[r], !n.getRegion(t)); r++)n = null;
				if (null != n)break
			}
			if (!n)return null;
			if (isNaN(e) || isNaN(a)) {
				...
				if (l = l ? l : this.findFirstDragonBonesData()) {
					...
					h && (e = h.pivot.x, a = h.pivot.y)
				}
			}
			return this._generateDisplay(n, t, e, a)
		}, s.buildArmature = function (t, i, e, a) {
			void 0 === i && (i = null), void 0 === e && (e = null), void 0 === a && (a = null);
			var n = {};
			this.fillBuildArmatureDataPackageArmatureInfo(t, i, n), null == e && (e = n.dragonBonesDataName);
			var s = n.dragonBonesData, r = n.armatureData;

			if(r) console.log(s, r, e, a, 'kekes');
			return r ? this.buildArmatureUsingArmatureDataFromTextureAtlas(s, r, e, a) : null
		}, s.buildFastArmature = function (t, i, a, n) {
			void 0 === i && (i = null), void 0 === a && (a = null), void 0 === n && (n = null);
			var s = new e;
			this.fillBuildArmatureDataPackageArmatureInfo(t, i, s), null == a && (a = s.dragonBonesDataName);
			var r = s.dragonBonesData, o = s.armatureData;
			...
			console.log('i', i, 't', t, 'e', e, 'a', a);
			return n.name = i.name, n.__dragonBonesData = t, n._armatureData = i, n.animation.animationDataList = i.animationDataList, this._buildBones(n), this._buildSlots(n, a, e), n.advanceTime(0), n
		}, s.buildFastArmatureUsingArmatureDataFromTextureAtlas = function (t, i, e, a) {
			void 0 === a && (a = null);
			var n = this._generateFastArmature();
			return n.name = i.name, n.__dragonBonesData = t, n._armatureData = i, n.animation.animationDataList = i.animationDataList, this._buildFastBones(n), this._buildFastSlots(n, a, e), n.advanceTime(0), n
		}, s.copyAnimationsToArmature = function (i, e, a, n) {
			void 0 === a && (a = null), void 0 === n && (n = !0);
			var s = {};
			if (!this.fillBuildArmatureDataPackageArmatureInfo(e, a, s))return !1;
			...
			for (var o, l, h, _, u, m, f = r.getSkinData(""), d = i.getSlots(!1), c = 0, p = d.length, g = 0; p > g; g++) {
				h = d[g], _ = h.displayList, c = _.length;
				for (var T = 0; c > T; T++)u = _[T], u instanceof t.Armature && (m = u, o = f.getSlotData(h.name), l = o.displayDataList[T], l.type == t.DisplayData.ARMATURE && this.copyAnimationsToArmature(m, l.name, s.dragonBonesDataName, n))
			}
			return !0
		}, s.fillBuildArmatureDataPackageArmatureInfo = function (t, i, e) {
			if (i)return e.dragonBonesDataName = i, e.dragonBonesData = this.dragonBonesDataDic[i], e.armatureData = e.dragonBonesData.getArmatureDataByName(t), !0;
			for (i in this.dragonBonesDataDic)if (e.dragonBonesData = this.dragonBonesDataDic[i], e.armatureData = e.dragonBonesData.getArmatureDataByName(t), e.armatureData)return e.dragonBonesDataName = i, !0;
			return !1
			...
			for (var e, a, n, s = i.armatureData.boneDataList, r = 0; r < s.length; r++)e = s[r], a = t.Bone.initWithBoneData(e), n = e.parent, n && null == i.armatureData.getBoneData(n) && (n = null), i.addBone(a, n, !0);
			...
			if (n) {
				...
				for (var s, r, o, l = [], h = i.armatureData.slotDataList, _ = 0; _ < h.length; _++)if (s = h[_], o = i.getBone(s.parent)) {
					r = this._generateSlot(), r.initWithSlotData(s), o.addSlot(r), l.length = 0;
					for (var u = s.displayDataList.length; u--;) {
						var m = s.displayDataList[u];
						switch (m.type) {
							case t.DisplayData.ARMATURE:
								console.log('case t.DisplayData.ARMATURE:', 'i', i, i.__dragonBonesData.getArmatureDataByName(m.name), 'm', m);
					...
					for (var d = 0, c = l.length; c > d; d++) {
						var p = l[d];
						if (p && (p instanceof t.Armature && (p = p.display), p.hasOwnProperty("name")))try {
							p.name = r.name
						} catch (g) {
						}
					}
					r.displayList = l, r._changeDisplay(s.displayIndex)
				}
			}
		}, s._buildFastBones = function (i) {
			for (var e, a, n = i.armatureData.boneDataList, s = 0; s < n.length; s++)e = n[s], a = t.FastBone.initWithBoneData(e), i.addBone(a, e.parent)
		}, s._buildFastSlots = function (i, e, a) {
			var n = i.armatureData.getSkinData(e);
			if (n) {
				i.armatureData.setSkinData(e);
				for (var s, r, o = [], l = i.armatureData.slotDataList, h = 0; h < l.length; h++) {
					o.length = 0, s = l[h], r = this._generateFastSlot(), r.initWithSlotData(s);
					...
					for (var f = o.length, d = 0; f > d; d++) {
						var c = o[d];
						if (c && (c instanceof t.FastArmature && (c = c.display), c.hasOwnProperty("name")))try {
							c.name = r.name
						} catch (p) {
						}
					}
					r.initDisplayList(o.concat()), i.addSlot(r, s.parent), r._changeDisplayIndex(s.displayIndex)
				}
			}
			...
			return null
		}, a._helpMatrix = new t.Matrix, a
	}(t.EventDispatcher);
	t.BaseFactory = i, egret.registerClass(i, "dragonBones.BaseFactory");
	var e = function () {
		function t() {
		}
	...
	t.BuildArmatureDataPackage = e, egret.registerClass(e, "dragonBones.BuildArmatureDataPackage")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (i) {
		function e(e) {
			i.call(this), this.isCacheManagerExclusive = !1, this._enableEventDispatch = !0, this.useCache = !0, this._display = e, this._animation = new t.FastAnimation(this), this._slotsZOrderChanged = !1, this._armatureData = null, this.boneList = [], this._boneDic = {}, this.slotList = [], this._slotDic = {}, this.slotHasChildArmatureList = [], this._eventList = [], this._delayDispose = !1, this._lockDispose = !1
		}
		...
		return s.dispose = function () {
			if (this._delayDispose = !0, this._animation && !this._lockDispose) {
				...
				this.slotList.length = 0, this.boneList.length = 0, this._armatureData = null, this._animation = null, this.slotList = null, this.boneList = null, this._eventList = null
			}
		}, s.advanceTime = function (t) {
			this._lockDispose = !0, this._animation.advanceTime(t);
			var i, e, a = 0;
			if (this._animation.animationState.isUseCache())for (this.useCache || (this.useCache = !0), a = this.slotList.length; a--;)e = this.slotList[a], e.updateByCache(); else {
				if (this.useCache)for (this.useCache = !1, a = this.slotList.length; a--;)e = this.slotList[a], e.switchTransformToBackup();
				for (a = this.boneList.length; a--;)i = this.boneList[a], i.update();
				for (a = this.slotList.length; a--;)e = this.slotList[a], e._update()
			}
			...
			void 0 === e && (e = null), void 0 === a && (a = !0);
			var n = t.AnimationCacheManager.initWithArmatureData(this.armatureData, i);
			if (e)for (var s = e.length, r = 0; s > r; r++) {
				var o = e[r];
				n.initAnimationCache(o)
			} else n.initAllAnimationCache();
			return n.setCacheGeneratorArmature(this), n.generateAllAnimationCache(a), n.bindCacheUserArmature(this), this.enableCache = !0, n
		}, s.getBone = function (t) {
			...
			if (t)for (var i = 0, e = this.slotList.length; e > i; i++)if (this.slotList[i].display == t)return this.slotList[i];
			return null
		}, s.getSlots = function (t) {
			return void 0 === t && (t = !0), t ? this.slotList.concat() : this.slotList
		}, s._updateBonesByCache = function () {
			for (var t, i = this.boneList.length; i--;)t = this.boneList[i], t.update()
		}, s.addBone = function (t, i) {
			void 0 === i && (i = null);
			var e;
			i && (e = this.getBone(i), e.boneList.push(t)), t.armature = this, t.setParent(e), this.boneList.unshift(t), this._boneDic[t.name] = t
		}, s.addSlot = function (t, i) {
			var e = this.getBone(i);
			if (!e)throw new Error;
			t.armature = this, t.setParent(e), e.slotList.push(t), t._addDisplayToContainer(this.display), this.slotList.push(t), this._slotDic[t.name] = t, t.hasChildArmature && this.slotHasChildArmatureList.push(t)
		}, s.updateSlotsZOrder = function () {
			...
			if (0 != i) {
				for (var e = []; i--;) {
					for (var a = 0, n = this.boneList[i], s = n; s;)a++, s = s.parent;
					e[i] = [a, n]
				}
				for (e.sort(t.ArmatureData.sortBoneDataHelpArrayDescending), i = e.length; i--;)this.boneList[i] = e[i][1];
				e.length = 0
			}
		}, s.arriveAtFrame = function (i, e) {
			if (i.event && this.hasEventListener(t.FrameEvent.ANIMATION_FRAME_EVENT)) {
				var a = new t.FrameEvent(t.FrameEvent.ANIMATION_FRAME_EVENT);
				a.animationState = e, a.frameLabel = i.event, this._addEvent(a)
			}
			...
			if (void 0 === t && (t = null), t) {
				var i = this.getBone(t);
				i && i.invalidUpdate()
			} else for (var e = this.boneList.length; e--;)this.boneList[e].invalidUpdate()
		}, s.resetAnimation = function () {
	...
	t.FastArmature = i, egret.registerClass(i, "dragonBones.FastArmature", ["dragonBones.ICacheableArmature", "dragonBones.IArmature", "dragonBones.IAnimatable"])
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return n.updateByCache = function () {
			...
			if (this.parent && (this.inheritTranslation || this.inheritRotation || this.inheritScale)) {
				var e = this._parent._global, a = this._parent._globalTransformMatrix;
				return (this.inheritTranslation || 0 == e.x && 0 == e.y) && (this.inheritRotation || 0 == e.skewX && 0 == e.skewY) && (this.inheritScale || 1 == e.scaleX && 1 == e.scaleY) || (e = i._tempParentGlobalTransform, e.copy(this._parent._global), this.inheritTranslation || (e.x = 0, e.y = 0), this.inheritScale || (e.scaleX = 1, e.scaleY = 1), this.inheritRotation || (e.skewX = 0, e.skewY = 0), a = t.DBObject._tempParentGlobalTransformMatrix, t.TransformUtil.transformToMatrix(e, a)), i.tempOutputObj.parentGlobalTransform = e, i.tempOutputObj.parentGlobalTransformMatrix = a, i.tempOutputObj
			}
			return null
		}, n._updateGlobal = function () {
			this._calculateRelativeParentTransform();
			...
			this._frameCache = t
		}), i._tempParentGlobalTransform = new t.DBTransform, i.tempOutputObj = {}, i
	}();
	t.FastDBObject = i, egret.registerClass(i, "dragonBones.FastDBObject")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (i) {
		function e() {
			i.call(this), this.slotList = [], this.boneList = [], this._needUpdate = 0, this._needUpdate = 2, this._tweenPivot = new t.Point
		}
		...
		return e.initWithBoneData = function (t) {
			...
			i.prototype.dispose.call(this), this._timelineState = null, this._tweenPivot = null
		}, s.invalidUpdate = function () {
			this._needUpdate = 2
		}, s._calculateRelativeParentTransform = function () {
			...
			i.prototype.updateByCache.call(this), this._global = this._frameCache.globalTransform, this._globalTransformMatrix = this._frameCache.globalTransformMatrix
		}, s.update = function (t) {
			void 0 === t && (t = !1), this._needUpdate--, (t || this._needUpdate > 0 || this._parent && this._parent._needUpdate > 0) && (this._needUpdate = 1, this.blendingTimeline(), this._updateGlobal())
		}, s._hideSlots = function () {
			...
			if (i.event && this.armature.hasEventListener(t.FrameEvent.BONE_FRAME_EVENT)) {
				...
				a.bone = this, a.animationState = e, a.frameLabel = i.event, this.armature._addEvent(a)
			}
		}, a(s, "childArmature", function () {
			var t = this.slot;
			...
			if (this._visible != t) {
				this._visible = t;
				for (var i = 0, e = this.armature.slotList.length; e > i; i++)this.armature.slotList[i].parent == this && this.armature.slotList[i]._updateDisplayVisible(this._visible)
			}
		}), a(s, "slot", function () {
			return this.slotList.length > 0 ? this.slotList[0] : null
		}), e
	}(t.FastDBObject);
	t.FastBone = i, egret.registerClass(i, "dragonBones.FastBone")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (i) {
		function e(e) {
			if (i.call(this), this._currentDisplayIndex = 0, e != this)throw new Error("Abstract class can not be instantiated!");
			this.hasChildArmature = !1, this._currentDisplayIndex = -1, this._originZOrder = 0, this._tweenZOrder = 0, this._offsetZOrder = 0, this._colorTransform = new t.ColorTransform, this._isColorChanged = !1, this._displayDataList = null, this._currentDisplay = null, this.inheritRotation = !0, this.inheritScale = !0
		}
		...
		return s.initWithSlotData = function (t) {
			...
			this._displayList && (i.prototype.dispose.call(this), this._displayDataList = null, this._displayList = null, this._currentDisplay = null)
		}, s.updateByCache = function () {
			i.prototype.updateByCache.call(this), this._updateTransform();
			var e = this._frameCache.colorTransform, a = null != e;
			(this.colorChanged != a || this.colorChanged && a && !t.ColorTransformUtil.isEqual(this._colorTransform, e)) && (e = e || t.ColorTransformUtil.originalColor, this._updateDisplayColor(e.alphaOffset, e.redOffset, e.greenOffset, e.blueOffset, e.alphaMultiplier, e.redMultiplier, e.greenMultiplier, e.blueMultiplier, a)), this._changeDisplayIndex(this._frameCache.displayIndex)
		}, s._update = function () {
			this._parent._needUpdate <= 0 || (this._updateGlobal(), this._updateTransform())
		}, s._calculateRelativeParentTransform = function () {
			...
			return this._removeDisplayFromContainer(), i
		}, s._changeDisplayIndex = function (t) {
			if (void 0 === t && (t = 0), this._currentDisplayIndex != t) {
				var i = -1;
				this._currentDisplayIndex >= 0 && (i = this.clearCurrentDisplay()), this._currentDisplayIndex = t, this._currentDisplayIndex >= 0 && (this._origin.copy(this._displayDataList[this._currentDisplayIndex].transform), this.initCurrentDisplay(i))
			}
		}, s.changeSlotDisplay = function (t) {
			var i = this.clearCurrentDisplay();
			this._displayList[this._currentDisplayIndex] = t, this.initCurrentDisplay(i)
		}, s.initCurrentDisplay = function (i) {
			void 0 === i && (i = 0);
			var e = this._displayList[this._currentDisplayIndex];
			if (e ? e instanceof t.FastArmature ? this._currentDisplay = e.display : this._currentDisplay = e : this._currentDisplay = null, this._updateDisplay(this._currentDisplay), this._currentDisplay && (-1 != i ? this._addDisplayToContainer(this.armature.display, i) : (this.armature._slotsZOrderChanged = !0, this._addDisplayToContainer(this.armature.display)), this._blendMode && this._updateDisplayBlendMode(this._blendMode), this._isColorChanged && this._updateDisplayColor(this._colorTransform.alphaOffset, this._colorTransform.redOffset, this._colorTransform.greenOffset, this._colorTransform.blueOffset, this._colorTransform.alphaMultiplier, this._colorTransform.redMultiplier, this._colorTransform.greenMultiplier, this._colorTransform.blueMultiplier, !0), this._updateTransform(), e instanceof t.FastArmature)) {
				var a = e;
			...
			if (!t)throw new Error;
			var i = t[this._currentDisplayIndex], e = this._currentDisplayIndex >= 0 && this._displayList[this._currentDisplayIndex] != i;
			this._displayList = t, e && this.changeSlotDisplay(i)
		}), a(s, "display", function () {
			return this._currentDisplay
		}, function (t) {
			...
			throw void 0 === i && (i = -1), new Error("Abstract method needs to be implemented in subclass!")
		}, s._removeDisplayFromContainer = function () {
			throw new Error("Abstract method needs to be implemented in subclass!")
		}, s._updateTransform = function () {
			throw new Error("Abstract method needs to be implemented in subclass!")
			...
			var e = t, a = e.displayIndex;
			if (this._changeDisplayIndex(a), this._updateDisplayVisible(e.visible), a >= 0 && (isNaN(e.zOrder) || e.zOrder == this._tweenZOrder || (this._tweenZOrder = e.zOrder, this.armature._slotsZOrderChanged = !0)), t.action) {
	...
	t.FastSlot = i, egret.registerClass(i, "dragonBones.FastSlot", ["dragonBones.ISlotCacheGenerator", "dragonBones.ICacheUser"])
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
	...
	t.Point = i, egret.registerClass(i, "dragonBones.Point")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		function t(t, i, e, a) {
			void 0 === t && (t = 0), void 0 === i && (i = 0), void 0 === e && (e = 0), void 0 === a && (a = 0), this.x = t, this.y = i, this.width = e, this.height = a
		}
	...
	t.Rectangle = i, egret.registerClass(i, "dragonBones.Rectangle")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
	...
	t.Timeline = i, egret.registerClass(i, "dragonBones.Timeline")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (t) {
		...
		return e(n, "timelineList", function () {
			...
			var i = 0, e = 0;
			for (i = 0, e = this._timelineList.length; e > i; i++) {
				var a = this._timelineList[i];
				a.dispose()
			}
			for (this._timelineList = null, i = 0, e = this._slotTimelineList.length; e > i; i++) {
				var n = this._slotTimelineList[i];
				n.dispose()
			}
			this._slotTimelineList = null
		}, n.getTimeline = function (t) {
			for (var i = this._timelineList.length; i--;)if (this._timelineList[i].name == t)return this._timelineList[i];
			return null
			...
			for (var i = this._slotTimelineList.length; i--;)if (this._slotTimelineList[i].name == t)return this._slotTimelineList[i];
			return null
	...
	t.AnimationData = i, egret.registerClass(i, "dragonBones.AnimationData")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		function t() {
			this._boneDataList = [], this._skinDataList = [], this._slotDataList = [], this._animationDataList = []
		}
		...
		return t.sortBoneDataHelpArray = function (t, i) {
			...
			var i = 0, e = this._slotDataList.length;
			for (i = 0; e > i; i++)this._slotDataList[i].dispose();
			var a;
			if (!t && this._skinDataList.length > 0)a = this._skinDataList[0]; else for (i = 0, e = this._skinDataList.length; e > i; i++)if (this._skinDataList[i].name == t) {
				a = this._skinDataList[i];
				break
			}
			if (a) {
				var n;
				for (i = 0, e = a.slotDataList.length, i = 0; e > i; i++)if (n = this.getSlotData(a.slotDataList[i].name)) {
					var s = 0, r = a.slotDataList[i].displayDataList.length;
					for (s = 0; r > s; s++)n.addDisplayData(a.slotDataList[i].displayDataList[s])
				}
			}
		}, a.dispose = function () {
			...
			this._boneDataList = null, this._slotDataList = null, this._skinDataList = null, this._animationDataList = null
		}, a.getBoneData = function (t) {
			for (var i = this._boneDataList.length; i--;)if (this._boneDataList[i].name == t)return this._boneDataList[i];
			return null
		}, a.getSlotData = function (t) {
			for (var i = this._slotDataList.length; i--;)if (this._slotDataList[i].name == t)return this._slotDataList[i];
			return null
		}, a.getSkinData = function (t) {
			if (!t && this._skinDataList.length > 0)return this._skinDataList[0];
			for (var i = this._skinDataList.length; i--;)if (this._skinDataList[i].name == t)return this._skinDataList[i];
			return null
		}, a.getAnimationData = function (t) {
			for (var i = this._animationDataList.length; i--;)if (this._animationDataList[i].name == t)return this._animationDataList[i];
			return null
			...
			if (0 != i) {
				for (var e = []; i--;) {
					for (var a = this._boneDataList[i], n = 0, s = a; s;)n++, s = this.getBoneData(s.parent);
					e[i] = [n, a]
				}
				for (e.sort(t.sortBoneDataHelpArray), i = e.length; i--;)this._boneDataList[i] = e[i][1]
			}
	...
	t.ArmatureData = i, egret.registerClass(i, "dragonBones.ArmatureData")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
	...
	t.BoneData = i, egret.registerClass(i, "dragonBones.BoneData")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
	...
	t.ColorTransform = i, egret.registerClass(i, "dragonBones.ColorTransform")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		function i() {
			this._dataChanged = !1, this._pointList = [], this.sampling = new Array(i.SamplingTimes);
			for (var e = 0; e < i.SamplingTimes - 1; e++)this.sampling[e] = new t.Point
		}
		...
		return n.getValueByProgress = function (t) {
			...
			for (var t = 0; t < i.SamplingTimes - 1; t++)this.bezierCurve(i.SamplingStep * (t + 1), this.sampling[t]);
			this._dataChanged = !1
		}, n.bezierCurve = function (t, i) {
			var e = 1 - t;
			i.x = 3 * this.point1.x * t * e * e + 3 * this.point2.x * t * t * e + Math.pow(t, 3), i.y = 3 * this.point1.y * t * e * e + 3 * this.point2.y * t * t * e + Math.pow(t, 3)
		...
		}), i.SamplingTimes = 20, i.SamplingStep = .05, i
	}();
	t.CurveData = i, egret.registerClass(i, "dragonBones.CurveData")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		}, i.ARMATURE = "armature", i.IMAGE = "image", i
	}();
	t.DisplayData = i, egret.registerClass(i, "dragonBones.DisplayData")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		function t() {
			this._armatureDataList = [], this._displayDataDictionary = {}
		}
		...
		return a.dispose = function () {
			...
			console.log('getArmatureDataByName', 't', t, 'this._armatureDataList', this._armatureDataList, this);
			for (var i = this._armatureDataList.length; i--;)if (this._armatureDataList[i].name == t)return this._armatureDataList[i];
			return null
			...
			for (var i = this._armatureDataList.length; i--;)this._armatureDataList[i].name == t && this._armatureDataList.splice(i, 1)
	...
	t.DragonBonesData = i, egret.registerClass(i, "dragonBones.DragonBonesData")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
	...
	t.Frame = i, egret.registerClass(i, "dragonBones.Frame")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
	...
	t.SkinData = i, egret.registerClass(i, "dragonBones.SkinData")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return a.dispose = function () {
			...
			for (var i = this._displayDataList.length; i--;)if (this._displayDataList[i].name == t)return this._displayDataList[i];
			return null
		}, i(a, "displayDataList", function () {
			return this._displayDataList
		}), t
	}();
	t.SlotData = i, egret.registerClass(i, "dragonBones.SlotData")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (t) {
	...
	t.SlotFrame = i, egret.registerClass(i, "dragonBones.SlotFrame")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (t) {
	...
	t.SlotTimeline = i, egret.registerClass(i, "dragonBones.SlotTimeline")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (i) {
		function e() {
			i.call(this), this.tweenRotate = 0, this.displayIndex = 0, this.tweenEasing = 10, this.tweenRotate = 0, this.tweenScale = !0, this.displayIndex = 0, this.visible = !0, this.zOrder = NaN, this.global = new t.DBTransform, this.transform = new t.DBTransform, this.pivot = new t.Point, this.scaleOffset = new t.Point
		}

		__extends(e, i);
		var a = (__define, e), n = a.prototype;
		return n.dispose = function () {
			i.prototype.dispose.call(this), this.global = null, this.transform = null, this.pivot = null, this.scaleOffset = null, this.color = null
		}, e
	}(t.Frame);
	t.TransformFrame = i, egret.registerClass(i, "dragonBones.TransformFrame")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function (i) {
		function e() {
			i.call(this), this.originTransform = new t.DBTransform, this.originTransform.scaleX = 1, this.originTransform.scaleY = 1, this.originPivot = new t.Point, this.offset = 0
		}

		__extends(e, i);
		var a = (__define, e), n = a.prototype;
		return n.dispose = function () {
			i.prototype.dispose.call(this), this.originTransform = null, this.originPivot = null
		}, e
	}(t.Timeline);
	t.TransformTimeline = i, egret.registerClass(i, "dragonBones.TransformTimeline")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return i.parseDragonBonesData = function (e) {
			...
			if (a = a.toString(), a.toString() != t.DragonBones.DATA_VERSION && a.toString() != t.DragonBones.PARENT_COORDINATE_DATA_VERSION && "2.3" != a.toString())throw new Error("Nonsupport version!");
			var n = i.getNumber(e, t.ConstValues.A_FRAME_RATE, 0) || 0, s = new t.DragonBonesData;
			s.name = e[t.ConstValues.A_NAME], s.isGlobal = "0" == e[t.ConstValues.A_IS_GLOBAL] ? !1 : !0, i.tempDragonBonesData = s;
			for (var r = e[t.ConstValues.ARMATURE], o = 0, l = r.length; l > o; o++) {
				var h = r[o];
				s.addArmatureData(i.parseArmatureData(h, n))
			}
			return i.tempDragonBonesData = null, s
			...
			for (s = 0, r = h.length; r > s; s++)for (var _ = h[s], u = _[t.ConstValues.SLOT], m = 0, f = u.length; f > m; m++) {
				var d = u[m];
			...
			i.tempDragonBonesData.isGlobal && t.DBDataUtil.transformArmatureData(n), n.sortBoneDataList();
			var p = e[t.ConstValues.ANIMATION];
			for (s = 0, r = p.length; r > s; s++) {
				var g = p[s], T = i.parseAnimationData(g, a);
				t.DBDataUtil.addHideTimeline(T, n), t.DBDataUtil.transformAnimationData(T, n, i.tempDragonBonesData.isGlobal), n.addAnimationData(T)
			}
			return n
		}, i.parseBoneData = function (e) {
			var a = new t.BoneData;
			return a.name = e[t.ConstValues.A_NAME], a.parent = e[t.ConstValues.A_PARENT], a.length = Number(e[t.ConstValues.A_LENGTH]) || 0, a.inheritRotation = i.getBoolean(e, t.ConstValues.A_INHERIT_ROTATION, !0), a.inheritScale = i.getBoolean(e, t.ConstValues.A_INHERIT_SCALE, !0), i.parseTransform(e[t.ConstValues.TRANSFORM], a.transform), i.tempDragonBonesData.isGlobal && a.global.copy(a.transform), a
			...
			a.name = e[t.ConstValues.A_NAME], a.parent = e[t.ConstValues.A_PARENT], a.zOrder = e[t.ConstValues.A_Z_ORDER], a.zOrder = i.getNumber(e, t.ConstValues.A_Z_ORDER, 0) || 0, a.blendMode = e[t.ConstValues.A_BLENDMODE];
			var n = e[t.ConstValues.DISPLAY];
			if (n)for (var s = 0, r = n.length; r > s; s++) {
				var o = n[s];
			...
			var a = new t.SlotData;
			return a.name = e[t.ConstValues.A_NAME], a.parent = e[t.ConstValues.A_PARENT], a.zOrder = e[t.ConstValues.A_Z_ORDER], a.zOrder = i.getNumber(e, t.ConstValues.A_Z_ORDER, 0) || 0, a.blendMode = e[t.ConstValues.A_BLENDMODE], a.displayIndex = 0, a
		}, i.parseDisplayData = function (e) {
			var a = new t.DisplayData;
			return a.name = e[t.ConstValues.A_NAME], a.type = e[t.ConstValues.A_TYPE], i.parseTransform(e[t.ConstValues.TRANSFORM], a.transform, a.pivot), null != i.tempDragonBonesData && i.tempDragonBonesData.addDisplayData(a), a
		}, i.parseAnimationData = function (e, a) {
			var n = new t.AnimationData;
			n.name = e[t.ConstValues.A_NAME], n.frameRate = a, n.duration = Math.round(1e3 * (i.getNumber(e, t.ConstValues.A_DURATION, 1) || 1) / a), n.playTimes = i.getNumber(e, t.ConstValues.A_LOOP, 1), n.playTimes = NaN != n.playTimes ? n.playTimes : 1, n.fadeTime = i.getNumber(e, t.ConstValues.A_FADE_IN_TIME, 0) || 0, n.scale = i.getNumber(e, t.ConstValues.A_SCALE, 1) || 0, n.tweenEasing = i.getNumber(e, t.ConstValues.A_TWEEN_EASING, NaN), n.autoTween = i.getBoolean(e, t.ConstValues.A_AUTO_TWEEN, !0);
			var s = e[t.ConstValues.FRAME], r = 0, o = 0;
			if (s)for (r = 0, o = s.length; o > r; r++) {
				var l = s[r], h = i.parseTransformFrame(l, null, a);
				n.addFrame(h)
			}
			i.parseTimeline(e, n);
			...
			if (m) {
				for (r = 0, o = m.length; o > r; r++) {
					var f = m[r], d = i.parseTransformTimeline(f, n.duration, a);
					d = i.parseTransformTimeline(f, n.duration, a), u = Math.min(u, d.frameList[d.frameList.length - 1].duration), n.addTimeline(d);
					var c = i.parseSlotTimeline(f, n.duration, a);
					if (n.addSlotTimeline(c), n.autoTween && !_)for (var p, g = 0, T = c.frameList.length; T > g; g++)if (p = c.frameList[g], p && p.displayIndex < 0) {
						_ = !0;
						break
					}
				}
				var v = n.tweenEasing;
				if (_) {
					for (o = n.slotTimelineList.length, r = 0; o > r; r++) {
						c = n.slotTimelineList[r], d = n.timelineList[r];
						var D, A, y;
						for (g = 0, T = c.frameList.length; T > g; g++)A = c.frameList[g], D = d.frameList[g], y = g == T - 1 ? c.frameList[0] : c.frameList[g + 1], A.displayIndex < 0 || y.displayIndex < 0 ? D.tweenEasing = A.tweenEasing = NaN : 10 == v ? D.tweenEasing = A.tweenEasing = 0 : isNaN(v) ? 10 == D.tweenEasing && (D.tweenEasing = 0) : D.tweenEasing = A.tweenEasing = v
					}
					n.autoTween = !1
				}
			}
			return n.frameList.length > 0 && (u = Math.min(u, n.frameList[n.frameList.length - 1].duration)), n.lastFrameDuration = u, n
		}, i.parseSlotTimeline = function (e, a, n) {
			var s = new t.SlotTimeline;
			s.name = e[t.ConstValues.A_NAME], s.scale = i.getNumber(e, t.ConstValues.A_SCALE, 1) || 0, s.offset = i.getNumber(e, t.ConstValues.A_OFFSET, 0) || 0, s.duration = a;
			for (var r = e[t.ConstValues.FRAME], o = 0, l = r.length; l > o; o++) {
				var h = r[o], _ = i.parseSlotFrame(h, n);
				s.addFrame(_)
			}
			return i.parseTimeline(e, s), s
		}, i.parseSlotFrame = function (e, a) {
			var n = new t.SlotFrame;
			i.parseFrame(e, n, a), n.visible = !i.getBoolean(e, t.ConstValues.A_HIDE, !1), n.tweenEasing = i.getNumber(e, t.ConstValues.A_TWEEN_EASING, 10), n.displayIndex = Math.floor(i.getNumber(e, t.ConstValues.A_DISPLAY_INDEX, 0) || 0), n.zOrder = i.getNumber(e, t.ConstValues.A_Z_ORDER, i.tempDragonBonesData.isGlobal ? NaN : 0);
			var s = e[t.ConstValues.COLOR_TRANSFORM];
			return s && (n.color = new t.ColorTransform, i.parseColorTransform(s, n.color)), n
		}, i.parseTransformTimeline = function (e, a, n) {
			var s = new t.TransformTimeline;
			s.name = e[t.ConstValues.A_NAME], s.scale = i.getNumber(e, t.ConstValues.A_SCALE, 1) || 0, s.offset = i.getNumber(e, t.ConstValues.A_OFFSET, 0) || 0, s.originPivot.x = i.getNumber(e, t.ConstValues.A_PIVOT_X, 0) || 0, s.originPivot.y = i.getNumber(e, t.ConstValues.A_PIVOT_Y, 0) || 0, s.duration = a;
			...
			return i.parseFrame(e, s, n), s.visible = !i.getBoolean(e, t.ConstValues.A_HIDE, !1), s.tweenEasing = i.getNumber(e, t.ConstValues.A_TWEEN_EASING, 10), s.tweenRotate = Math.floor(i.getNumber(e, t.ConstValues.A_TWEEN_ROTATE, 0) || 0), s.tweenScale = i.getBoolean(e, t.ConstValues.A_TWEEN_SCALE, !0), a && -1 == Math.floor(i.getNumber(a, t.ConstValues.A_DISPLAY_INDEX, 0) || 0) && (s.tweenEasing = NaN), i.parseTransform(e[t.ConstValues.TRANSFORM], s.transform, s.pivot), i.tempDragonBonesData.isGlobal && s.global.copy(s.transform), s.scaleOffset.x = i.getNumber(e, t.ConstValues.A_SCALE_X_OFFSET, 0) || 0, s.scaleOffset.y = i.getNumber(e, t.ConstValues.A_SCALE_Y_OFFSET, 0) || 0, s
		}, i.parseTimeline = function (t, i) {
			for (var e, a = 0, n = i.frameList, s = 0, r = n.length; r > s; s++)e = n[s], e.position = a, a += e.duration;
			e && (e.duration = i.duration - e.position)
		}, i.parseFrame = function (i, e, a) {
			void 0 === a && (a = 0), e.duration = Math.round(1e3 * (i[t.ConstValues.A_DURATION] || 1) / a), e.action = i[t.ConstValues.A_ACTION], e.event = i[t.ConstValues.A_EVENT], e.sound = i[t.ConstValues.A_SOUND]
		}, i.parseTransform = function (e, a, n) {
			void 0 === n && (n = null), e && (a && (a.x = i.getNumber(e, t.ConstValues.A_X, 0) || 0, a.y = i.getNumber(e, t.ConstValues.A_Y, 0) || 0, a.skewX = i.getNumber(e, t.ConstValues.A_SKEW_X, 0) * t.ConstValues.ANGLE_TO_RADIAN || 0, a.skewY = i.getNumber(e, t.ConstValues.A_SKEW_Y, 0) * t.ConstValues.ANGLE_TO_RADIAN || 0, a.scaleX = i.getNumber(e, t.ConstValues.A_SCALE_X, 1) || 0, a.scaleY = i.getNumber(e, t.ConstValues.A_SCALE_Y, 1) || 0), n && (n.x = i.getNumber(e, t.ConstValues.A_PIVOT_X, 0) || 0, n.y = i.getNumber(e, t.ConstValues.A_PIVOT_Y, 0) || 0))
		}, i.parseColorTransform = function (e, a) {
			e && a && (a.alphaOffset = i.getNumber(e, t.ConstValues.A_ALPHA_OFFSET, 0), a.redOffset = i.getNumber(e, t.ConstValues.A_RED_OFFSET, 0), a.greenOffset = i.getNumber(e, t.ConstValues.A_GREEN_OFFSET, 0), a.blueOffset = i.getNumber(e, t.ConstValues.A_BLUE_OFFSET, 0), a.alphaMultiplier = .01 * i.getNumber(e, t.ConstValues.A_ALPHA_MULTIPLIER, 100), a.redMultiplier = .01 * i.getNumber(e, t.ConstValues.A_RED_MULTIPLIER, 100), a.greenMultiplier = .01 * i.getNumber(e, t.ConstValues.A_GREEN_MULTIPLIER, 100), a.blueMultiplier = .01 * i.getNumber(e, t.ConstValues.A_BLUE_MULTIPLIER, 100))
		}, i.getBoolean = function (t, i, e) {
			if (t && i in t)switch (String(t[i])) {
				case"0":
				case"NaN":
				case"":
				case"false":
	...
	t.Data3Parser = i, egret.registerClass(i, "dragonBones.Data3Parser")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return i.parseTextureAtlasData = function (e, a) {
			...
			for (var n, s = {}, r = e[t.ConstValues.SUB_TEXTURE], o = 0, l = r.length; l > o; o++) {
				var h = r[o], _ = h[t.ConstValues.A_NAME], u = new t.Rectangle;
				u.x = i.getNumber(h, t.ConstValues.A_X, 0) / a, u.y = i.getNumber(h, t.ConstValues.A_Y, 0) / a, u.width = i.getNumber(h, t.ConstValues.A_WIDTH, 0) / a, u.height = i.getNumber(h, t.ConstValues.A_HEIGHT, 0) / a;
				var m = "true" == h[t.ConstValues.A_ROTATED], f = i.getNumber(h, t.ConstValues.A_FRAME_WIDTH, 0) / a, d = i.getNumber(h, t.ConstValues.A_FRAME_HEIGHT, 0) / a;
				f > 0 && d > 0 ? (n = new t.Rectangle, n.x = i.getNumber(h, t.ConstValues.A_FRAME_X, 0) / a, n.y = i.getNumber(h, t.ConstValues.A_FRAME_Y, 0) / a, n.width = f, n.height = d) : n = null, s[_] = new t.TextureData(u, n, m)
			}
			return s
		}, i.parseDragonBonesData = function (e) {
			if (!e)throw new Error;
			var a = e[t.ConstValues.A_VERSION];
			if (a = a.toString(), a.toString() != t.DragonBones.DATA_VERSION && a.toString() != t.DragonBones.PARENT_COORDINATE_DATA_VERSION && "2.3" != a.toString())throw new Error(egret.getString(4003));
			if (a.toString() == t.DragonBones.PARENT_COORDINATE_DATA_VERSION || "2.3" == a.toString())return t.Data3Parser.parseDragonBonesData(e);
			var n = i.getNumber(e, t.ConstValues.A_FRAME_RATE, 0) || 0, s = new t.DragonBonesData;
			s.name = e[t.ConstValues.A_NAME], s.isGlobal = "0" == e[t.ConstValues.A_IS_GLOBAL] ? !1 : !0, i.tempDragonBonesData = s;
			for (var r = e[t.ConstValues.ARMATURE], o = 0, l = r.length; l > o; o++) {
				var h = r[o];
			...
			for (s = 0, r = u.length; r > s; s++) {
				var m = u[s];
				n.addSkinData(i.parseSkinData(m))
			}
			i.tempDragonBonesData.isGlobal && t.DBDataUtil.transformArmatureData(n), n.sortBoneDataList();
			var f = e[t.ConstValues.ANIMATION];
			for (s = 0, r = f.length; r > s; s++) {
				var d = f[s], c = i.parseAnimationData(d, a);
				t.DBDataUtil.addHideTimeline(c, n, !0), t.DBDataUtil.transformAnimationData(c, n, i.tempDragonBonesData.isGlobal), n.addAnimationData(c)
			}
			return n
		}, i.parseBoneData = function (e) {
			var a = new t.BoneData;
			...
			var a = new t.SlotData;
			return a.name = e[t.ConstValues.A_NAME], a.parent = e[t.ConstValues.A_PARENT], a.zOrder = i.getNumber(e, t.ConstValues.A_Z_ORDER, 0) || 0, a.displayIndex = i.getNumber(e, t.ConstValues.A_DISPLAY_INDEX, 0), a.blendMode = e[t.ConstValues.A_BLENDMODE], a
		}, i.parseSlotDisplayData = function (e) {
			var a = new t.SlotData;
			a.name = e[t.ConstValues.A_NAME], a.parent = e[t.ConstValues.A_PARENT], a.zOrder = i.getNumber(e, t.ConstValues.A_Z_ORDER, 0) || 0;
			var n = e[t.ConstValues.DISPLAY];
			if (n)for (var s = 0, r = n.length; r > s; s++) {
				var o = n[s];
				a.addDisplayData(i.parseDisplayData(o))
			...
			var a = new t.DisplayData;
			return a.name = e[t.ConstValues.A_NAME], a.type = e[t.ConstValues.A_TYPE], i.parseTransform(e[t.ConstValues.TRANSFORM], a.transform, a.pivot), a.pivot.x = NaN, a.pivot.y = NaN, null != i.tempDragonBonesData && i.tempDragonBonesData.addDisplayData(a), a
		}, i.parseAnimationData = function (e, a) {
			var n = new t.AnimationData;
			n.name = e[t.ConstValues.A_NAME], n.frameRate = a, n.duration = Math.ceil(1e3 * (i.getNumber(e, t.ConstValues.A_DURATION, 1) || 1) / a), n.playTimes = i.getNumber(e, t.ConstValues.A_PLAY_TIMES, 1), n.playTimes = NaN != n.playTimes ? n.playTimes : 1, n.fadeTime = i.getNumber(e, t.ConstValues.A_FADE_IN_TIME, 0) || 0, n.scale = i.getNumber(e, t.ConstValues.A_SCALE, 1) || 0, n.tweenEasing = i.getNumber(e, t.ConstValues.A_TWEEN_EASING, NaN), n.autoTween = i.getBoolean(e, t.ConstValues.A_AUTO_TWEEN, !0);
			var s = e[t.ConstValues.FRAME], r = 0, o = 0;
			if (s)for (r = 0, o = s.length; o > r; r++) {
				var l = s[r], h = i.parseTransformFrame(l, a);
				n.addFrame(h)
			}
			i.parseTimeline(e, n);
			var _ = n.duration, u = e[t.ConstValues.BONE];
			if (u)for (r = 0, o = u.length; o > r; r++) {
				var m = u[r];
				if (m) {
					var f = i.parseTransformTimeline(m, n.duration, a);
					f.frameList.length > 0 && (_ = Math.min(_, f.frameList[f.frameList.length - 1].duration)), n.addTimeline(f)
				}
			}
			var d = e[t.ConstValues.SLOT];
			if (d)for (r = 0, o = d.length; o > r; r++) {
				var c = d[r];
				if (c) {
					var p = i.parseSlotTimeline(c, n.duration, a);
					p.frameList.length > 0 && (_ = Math.min(_, p.frameList[p.frameList.length - 1].duration), n.addSlotTimeline(p))
				}
			}
			return n.frameList.length > 0 && (_ = Math.min(_, n.frameList[n.frameList.length - 1].duration)), n.lastFrameDuration = _, n
		}, i.parseTransformTimeline = function (e, a, n) {
			var s = new t.TransformTimeline;
			s.name = e[t.ConstValues.A_NAME], s.scale = i.getNumber(e, t.ConstValues.A_SCALE, 1) || 0, s.offset = i.getNumber(e, t.ConstValues.A_OFFSET, 0) || 0, s.originPivot.x = i.getNumber(e, t.ConstValues.A_PIVOT_X, 0) || 0, s.originPivot.y = i.getNumber(e, t.ConstValues.A_PIVOT_Y, 0) || 0, s.duration = a;
			for (var r = e[t.ConstValues.FRAME], o = 0, l = r.length; l > o; o++) {
				var h = r[o], _ = i.parseTransformFrame(h, n);
				s.addFrame(_)
			}
			return i.parseTimeline(e, s), s
		}, i.parseSlotTimeline = function (e, a, n) {
			...
			null != n && 4 == n.length && (e.curve = new t.CurveData, e.curve.pointList = [new t.Point(n[0], n[1]), new t.Point(n[2], n[3])])
		}, i.parseTransform = function (e, a, n) {
			void 0 === n && (n = null), e && (a && (a.x = i.getNumber(e, t.ConstValues.A_X, 0) || 0, a.y = i.getNumber(e, t.ConstValues.A_Y, 0) || 0, a.skewX = i.getNumber(e, t.ConstValues.A_SKEW_X, 0) * t.ConstValues.ANGLE_TO_RADIAN || 0, a.skewY = i.getNumber(e, t.ConstValues.A_SKEW_Y, 0) * t.ConstValues.ANGLE_TO_RADIAN || 0, a.scaleX = i.getNumber(e, t.ConstValues.A_SCALE_X, 1) || 0, a.scaleY = i.getNumber(e, t.ConstValues.A_SCALE_Y, 1) || 0), n && (n.x = i.getNumber(e, t.ConstValues.A_PIVOT_X, 0) || 0, n.y = i.getNumber(e, t.ConstValues.A_PIVOT_Y, 0) || 0))
		}, i.parseColorTransform = function (e, a) {
			a && (a.alphaOffset = i.getNumber(e, t.ConstValues.A_ALPHA_OFFSET, 0), a.redOffset = i.getNumber(e, t.ConstValues.A_RED_OFFSET, 0), a.greenOffset = i.getNumber(e, t.ConstValues.A_GREEN_OFFSET, 0), a.blueOffset = i.getNumber(e, t.ConstValues.A_BLUE_OFFSET, 0), a.alphaMultiplier = .01 * i.getNumber(e, t.ConstValues.A_ALPHA_MULTIPLIER, 100), a.redMultiplier = .01 * i.getNumber(e, t.ConstValues.A_RED_MULTIPLIER, 100), a.greenMultiplier = .01 * i.getNumber(e, t.ConstValues.A_GREEN_MULTIPLIER, 100), a.blueMultiplier = .01 * i.getNumber(e, t.ConstValues.A_BLUE_MULTIPLIER, 100))
	...
	t.DataParser = i, egret.registerClass(i, "dragonBones.DataParser")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		function t(t, i, e) {
			this.region = t, this.frame = i, this.rotated = e
		}
	...
	t.TextureData = i, egret.registerClass(i, "dragonBones.TextureData")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return i.cloneColor = function (i) {
			...
			return e.redMultiplier = i.redMultiplier, e.greenMultiplier = i.greenMultiplier, e.blueMultiplier = i.blueMultiplier, e.alphaMultiplier = i.alphaMultiplier, e.redOffset = i.redOffset, e.greenOffset = i.greenOffset, e.blueOffset = i.blueOffset, e.alphaOffset = i.alphaOffset, e
			...
			e.alphaOffset = t.alphaOffset - i.alphaOffset, e.redOffset = t.redOffset - i.redOffset, e.greenOffset = t.greenOffset - i.greenOffset, e.blueOffset = t.blueOffset - i.blueOffset, e.alphaMultiplier = t.alphaMultiplier - i.alphaMultiplier,
				e.redMultiplier = t.redMultiplier - i.redMultiplier, e.greenMultiplier = t.greenMultiplier - i.greenMultiplier, e.blueMultiplier = t.blueMultiplier - i.blueMultiplier
		}, i.originalColor = new t.ColorTransform, i
	}();
	t.ColorTransformUtil = i, egret.registerClass(i, "dragonBones.ColorTransformUtil")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return i.transformArmatureData = function (i) {
			for (var e = i.boneDataList, a = e.length; a--;) {
				...
				if (n.parent) {
					...
					s && (n.transform.copy(n.global), t.TransformUtil.globalToLocal(n.transform, s.global))
				}
			}
		}, i.transformArmatureDataAnimations = function (t) {
			for (var e = t.animationDataList, a = e.length; a--;)i.transformAnimationData(e[a], t, !1)
		}, i.transformRelativeAnimationData = function (t, i) {
		}, i.transformAnimationData = function (e, a, n) {
			if (!n)return void i.transformRelativeAnimationData(e, a);
			var s, r = a.getSkinData(null), o = a.boneDataList;
			r && (s = r.slotDataList);
			for (var l = 0; l < o.length; l++) {
				var h = o[l], _ = e.getTimeline(h.name), u = e.getSlotTimeline(h.name);
				if (_ || u) {
					var m = null;
					if (s)for (var f = 0, d = s.length; d > f && (m = s[f], m.parent != h.name); f++);
					var c = _.frameList;
					if (u)var p = u.frameList;
					for (var g = null, T = c.length, f = 0; T > f; f++) {
						var v = c[f];
						if (i.setFrameTransform(e, a, h, v), v.transform.x -= h.transform.x, v.transform.y -= h.transform.y, v.transform.skewX -= h.transform.skewX, v.transform.skewY -= h.transform.skewY, v.transform.scaleX /= h.transform.scaleX, v.transform.scaleY /= h.transform.scaleY, g) {
							var D = v.transform.skewX - g.transform.skewX;
							g.tweenRotate ? g.tweenRotate > 0 ? (0 > D && (v.transform.skewX += 2 * Math.PI, v.transform.skewY += 2 * Math.PI), g.tweenRotate > 1 && (v.transform.skewX += 2 * Math.PI * (g.tweenRotate - 1), v.transform.skewY += 2 * Math.PI * (g.tweenRotate - 1))) : (D > 0 && (v.transform.skewX -= 2 * Math.PI, v.transform.skewY -= 2 * Math.PI), g.tweenRotate < 1 && (v.transform.skewX += 2 * Math.PI * (g.tweenRotate + 1), v.transform.skewY += 2 * Math.PI * (g.tweenRotate + 1))) : (v.transform.skewX = g.transform.skewX + t.TransformUtil.formatRadian(v.transform.skewX - g.transform.skewX), v.transform.skewY = g.transform.skewY + t.TransformUtil.formatRadian(v.transform.skewY - g.transform.skewY))
						}
						g = v
					}
					if (u && p) {
			...
			if (r) {
				...
				if (o) {
					for (var l = [], h = []; o;)l.push(o), h.push(r), r = a.getBoneData(r.parent), o = r ? e.getTimeline(r.name) : null;
					for (var _, u = l.length, m = new t.Matrix, f = new t.DBTransform, d = new t.Matrix; u--;)o = l[u], r = h[u], i.getTimelineTransform(o, s.position, f, !_), _ ? (f.x += o.originTransform.x + r.transform.x, f.y += o.originTransform.y + r.transform.y, f.skewX += o.originTransform.skewX + r.transform.skewX, f.skewY += o.originTransform.skewY + r.transform.skewY, f.scaleX *= o.originTransform.scaleX * r.transform.scaleX, f.scaleY *= o.originTransform.scaleY * r.transform.scaleY, t.TransformUtil.transformToMatrix(f, d, !0), d.concat(m), t.TransformUtil.matrixToTransform(d, _, f.scaleX * _.scaleX >= 0, f.scaleY * _.scaleY >= 0)) : (_ = new t.DBTransform, _.copy(f)), t.TransformUtil.transformToMatrix(_, m, !0);
			...
			for (var s = i.frameList, r = s.length; r--;) {
				...
				if (o.position <= e && o.position + o.duration > e) {
					if (r == s.length - 1 || e == o.position)a.copy(n ? o.global : o.transform); else {
						var l = o.tweenEasing, h = (e - o.position) / o.duration;
						l && 10 != l && (h = t.MathUtil.getEaseValue(h, l));
						var _ = s[r + 1], u = n ? o.global : o.transform, m = n ? _.global : _.transform;
						a.x = u.x + (m.x - u.x) * h, a.y = u.y + (m.y - u.y) * h, a.skewX = t.TransformUtil.formatRadian(u.skewX + (m.skewX - u.skewX) * h), a.skewY = t.TransformUtil.formatRadian(u.skewY + (m.skewY - u.skewY) * h), a.scaleX = u.scaleX + (m.scaleX - u.scaleX) * h, a.scaleY = u.scaleY + (m.scaleY - u.scaleY) * h
					}
					break
				}
			}
			...
			if (e) {
				s = n.length;
				for (var l, h; s--;)l = n[s], h = l.name, t.getSlotTimeline(h) || t.hideSlotTimelineNameMap.indexOf(h) < 0 && t.hideSlotTimelineNameMap.push(h)
			}
		}, i
	}();
	t.DBDataUtil = i, egret.registerClass(i, "dragonBones.DBDataUtil")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return t.getEaseValue = function (i, e) {
			var a = 1;
			return e > 1 ? (a = .5 * (1 - t.cos(i * Math.PI)), e -= 1) : e > 0 ? a = 1 - Math.pow(1 - i, 2) : 0 > e && (e *= -1, a = Math.pow(i, 2)), (a - i) * e + i
		}, t.isNumber = function (t) {
			return "number" == typeof t && !isNaN(t)
		}, t.sin = function (i) {
			i *= t.RADIAN_TO_ANGLE;
			var e = Math.floor(i), a = e + 1, n = t.sinInt(e), s = t.sinInt(a);
			return (i - e) * s + (a - i) * n
		}, t.sinInt = function (t) {
	...
	t.MathUtil = i, egret.registerClass(i, "dragonBones.MathUtil")
}(dragonBones || (dragonBones = {}));
...
!function (t) {
	var i = function () {
		...
		return i.globalToLocal = function (t, e) {
			i.transformToMatrix(t, i._helpTransformMatrix, !0), i.transformToMatrix(e, i._helpParentTransformMatrix, !0), i._helpParentTransformMatrix.invert(), i._helpTransformMatrix.concat(i._helpParentTransformMatrix), i.matrixToTransform(i._helpTransformMatrix, t, t.scaleX * e.scaleX >= 0, t.scaleY * e.scaleY >= 0)
		}, i.transformToMatrix = function (i, e, a) {
			void 0 === a && (a = !1), a ? (e.a = i.scaleX * t.MathUtil.cos(i.skewY), e.b = i.scaleX * t.MathUtil.sin(i.skewY), e.c = -i.scaleY * t.MathUtil.sin(i.skewX), e.d = i.scaleY * t.MathUtil.cos(i.skewX), e.tx = i.x, e.ty = i.y) : (e.a = t.MathUtil.cos(i.skewY), e.b = t.MathUtil.sin(i.skewY), e.c = -t.MathUtil.sin(i.skewX), e.d = t.MathUtil.cos(i.skewX), e.tx = i.x, e.ty = i.y)
		}, i.matrixToTransform = function (t, i, e, a) {
			i.x = t.tx, i.y = t.ty, i.scaleX = Math.sqrt(t.a * t.a + t.b * t.b) * (e ? 1 : -1), i.scaleY = Math.sqrt(t.d * t.d + t.c * t.c) * (a ? 1 : -1);
			var n = [];
			n[0] = Math.acos(t.d / i.scaleY), n[1] = -n[0], n[2] = Math.asin(-t.c / i.scaleY), n[3] = n[2] >= 0 ? Math.PI - n[2] : n[2] - Math.PI, Number(n[0]).toFixed(4) == Number(n[2]).toFixed(4) || Number(n[0]).toFixed(4) == Number(n[3]).toFixed(4) ? i.skewX = n[0] : i.skewX = n[1];
			var s = [];
			s[0] = Math.acos(t.a / i.scaleX), s[1] = -s[0], s[2] = Math.asin(t.b / i.scaleX), s[3] = s[2] >= 0 ? Math.PI - s[2] : s[2] - Math.PI, Number(s[0]).toFixed(4) == Number(s[2]).toFixed(4) || Number(s[0]).toFixed(4) == Number(s[3]).toFixed(4) ? i.skewY = s[0] : i.skewY = s[1]
		}, i.formatRadian = function (t) {
			return t > Math.PI && (t -= i.DOUBLE_PI), t < -Math.PI && (t += i.DOUBLE_PI), t
		}, i.normalizeRotation = function (t) {
			return t = (t + Math.PI) % (2 * Math.PI), t = t > 0 ? t : 2 * Math.PI + t, t - Math.PI
		}, i.HALF_PI = .5 * Math.PI, i.DOUBLE_PI = 2 * Math.PI, i._helpTransformMatrix = new t.Matrix, i._helpParentTransformMatrix = new t.Matrix, i
	}();
	t.TransformUtil = i, egret.registerClass(i, "dragonBones.TransformUtil")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		function i(i) {
			this.animationState = new t.FastAnimationState, this._armature = i, this.animationState._armature = i, this.animationList = [], this._animationDataObj = {}, this._isPlaying = !1, this._timeScale = 1
		}
		...
		return n.dispose = function () {
			...
			if (void 0 === i && (i = -1), void 0 === e && (e = -1), void 0 === a && (a = NaN), !this._animationDataList)return null;
			var n = this._animationDataObj[t];
			if (!n)return null;
			this._isPlaying = !0, i = 0 > i ? n.fadeTime < 0 ? .3 : n.fadeTime : i;
			var s;
			s = 0 > e ? n.scale < 0 ? 1 : n.scale : 1e3 * e / n.duration, a = isNaN(a) ? n.playTimes : a, this.animationState._fadeIn(n, a, 1 / s, i), this._armature.enableCache && this.animationCacheManager && (this.animationState.animationCache = this.animationCacheManager.getAnimationCache(t));
			for (var r = this._armature.slotHasChildArmatureList.length; r--;) {
				var o = this._armature.slotHasChildArmatureList[r], l = o.childArmature;
				l && l.getAnimation().gotoAndPlay(t)
			}
			return this.animationState
		}, n.gotoAndStop = function (t, i, e, a, n) {
			return void 0 === e && (e = -1), void 0 === a && (a = 0), void 0 === n && (n = -1), this.animationState.name != t && this.gotoAndPlay(t, a, n), e >= 0 ? this.animationState.setCurrentTime(this.animationState.totalTime * e) : this.animationState.setCurrentTime(i), this.animationState.stop(), this.animationState
		}, n.play = function () {
			...
			for (var i = this._animationDataList.length, e = 0; i > e; e++) {
				...
				this.animationList.push(a.name), this._animationDataObj[a.name] = a
			}
		}), e(n, "movementList", function () {
	...
	t.FastAnimation = i, egret.registerClass(i, "dragonBones.FastAnimation")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return n.dispose = function () {
			...
			for (var i, e = this.animationData.timelineList.length, a = 0; e > a; a++) {
				...
				if (s) {
					...
					r.fadeIn(s, this, n), this._boneTimelineStateList.push(r)
				}
			}
			for (var o = this.animationData.slotTimelineList.length, l = 0; o > l; l++) {
				...
				if (_ && _.displayList.length > 0) {
					...
					u.fadeIn(_, this, h), this._slotTimelineStateList.push(u)
				}
			}
		}, n._advanceTime = function (t) {
			...
			var e = !1, a = !1, n = !1, s = !1, r = 0, o = 1e3 * this._time;
			0 == this._playTimes || o < this._playTimes * this._totalTime ? (s = !1, this._progress = o / this._totalTime, r = Math.ceil(this.progress) || 1, this._progress -= Math.floor(this.progress), o %= this._totalTime) : (r = this._playTimes, o = this._totalTime, s = !0, this._progress = 1), this._isComplete = s, this.isUseCache() ? this.animationCache.update(this.progress) : this.updateTransformTimeline(this.progress), this._currentTime != o && (this._currentPlayTimes != r && (this._currentPlayTimes > 0 && r > 1 && (a = !0), this._currentPlayTimes = r), this._currentTime < 0 && (e = !0), this._isComplete && (n = !0), this._lastTime = this._currentTime, this._currentTime = o, this.updateMainTimeline(s));
			var l;
			e && this._armature.hasEventListener(t.AnimationEvent.START) && (l = new t.AnimationEvent(t.AnimationEvent.START), l.animationState = this, this._armature._addEvent(l)), n ? this._armature.hasEventListener(t.AnimationEvent.COMPLETE) && (l = new t.AnimationEvent(t.AnimationEvent.COMPLETE), l.animationState = this, this._armature._addEvent(l)) : a && this._armature.hasEventListener(t.AnimationEvent.LOOP_COMPLETE) && (l = new t.AnimationEvent(t.AnimationEvent.LOOP_COMPLETE), l.animationState = this, this._armature._addEvent(l))
		}, n.updateTransformTimeline = function (t) {
			var i, e, a = this._boneTimelineStateList.length;
			if (this._isComplete) {
				for (; a--;)i = this._boneTimelineStateList[a], i.update(t), this._isComplete = i._isComplete && this._isComplete;
				for (a = this._slotTimelineStateList.length; a--;)e = this._slotTimelineStateList[a], e.update(t), this._isComplete = e._isComplete && this._isComplete
			} else {
				for (; a--;)i = this._boneTimelineStateList[a], i.update(t);
				for (a = this._slotTimelineStateList.length; a--;)e = this._slotTimelineStateList[a], e.update(t)
			}
		}, n.updateMainTimeline = function (t) {
			...
			if (i.length > 0) {
				for (var e, a, n = 0, s = this.animationData.frameList.length; s > n; ++n) {
					if (this._currentFrameIndex < 0)this._currentFrameIndex = 0; else {
						if (!(this._currentTime < this._currentFramePosition || this._currentTime >= this._currentFramePosition + this._currentFrameDuration || this._currentTime < this._lastTime))break;
						if (this._lastTime = this._currentTime, this._currentFrameIndex++, this._currentFrameIndex >= i.length) {
							if (t) {
								this._currentFrameIndex--;
								break
							}
					...
					a = i[this._currentFrameIndex], e && this._armature.arriveAtFrame(e, this), this._currentFrameDuration = a.duration, this._currentFramePosition = a.position, e = a
				}
			...
			for (var t = this.animationData.hideTimelineNameMap.length, i = 0; t > i; i++) {
				var e = this.animationData.hideTimelineNameMap[i], a = this._armature.getBone(e);
				a && a._hideSlots()
			}
			var n;
			for (i = 0, t = this.animationData.hideSlotTimelineNameMap.length; t > i; i++) {
	...
	t.FastAnimationState = i, egret.registerClass(i, "dragonBones.FastAnimationState", ["dragonBones.IAnimationState"])
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return i.borrowObject = function () {
			...
			switch (this._bone = i, this._animationState = e, this._timelineData = a, this.name = a.name, this._totalTime = this._timelineData.duration, this._isComplete = !1, this._tweenTransform = !1, this._currentFrameIndex = -1, this._currentTime = -1, this._tweenEasing = NaN, this._durationPivot.x = 0, this._durationPivot.y = 0, this._pivot.x = 0, this._pivot.y = 0, this._originPivot = this._timelineData.originPivot, this._timelineData.frameList.length) {
				case 0:
					this._updateMode = 0;
					break;
				case 1:
			...
			if (e._fadeTotalTime > 0) {
				...
				this._durationTransform.copy(n.transform), this._durationTransform.minus(this._transformToFadein)
			}
			...
			t /= this._timelineData.scale, t += this._timelineData.offset;
			var e = this._totalTime * t, a = this._animationState.playTimes;
			if (0 == a)this._isComplete = !1, i = Math.ceil(Math.abs(e) / this._totalTime) || 1, e -= Math.floor(e / this._totalTime) * this._totalTime, 0 > e && (e += this._totalTime); else {
				var n = a * this._totalTime;
				e >= n ? (e = n, this._isComplete = !0) : -n >= e ? (e = -n, this._isComplete = !0) : this._isComplete = !1, 0 > e && (e += n), i = Math.ceil(e / this._totalTime) || 1, this._isComplete ? e = this._totalTime : e -= Math.floor(e / this._totalTime) * this._totalTime
			}
			if (this._currentTime != e) {
				this._lastTime = this._currentTime, this._currentTime = e;
				for (var s, r, o = this._timelineData.frameList, l = 0, h = this._timelineData.frameList.length; h > l; ++l) {
					...
					r = o[this._currentFrameIndex], s && this._bone.arriveAtFrame(s, this._animationState), this._currentFrameDuration = r.duration, this._currentFramePosition = r.position, s = r
				}
				r && (this._bone.arriveAtFrame(r, this._animationState), this.updateToNextFrame(i)), this._tweenTransform && this.updateTween()
			}
		}, a.updateToNextFrame = function (i) {
			void 0 === i && (i = 0);
			var e = this._currentFrameIndex + 1;
			...
			var e = this._timelineData.frameList[this._currentFrameIndex], a = e.transform, n = e.pivot;
			this._transform.x = a.x + this._durationTransform.x * i, this._transform.y = a.y + this._durationTransform.y * i, this._transform.skewX = a.skewX + this._durationTransform.skewX * i, this._transform.skewY = a.skewY + this._durationTransform.skewY * i, this._transform.scaleX = a.scaleX + this._durationTransform.scaleX * i, this._transform.scaleY = a.scaleY + this._durationTransform.scaleY * i, this._pivot.x = n.x + this._durationPivot.x * i, this._pivot.y = n.y + this._durationPivot.y * i, this._bone.invalidUpdate()
		}, i._pool = [], i
	}();
	t.FastBoneTimelineState = i, egret.registerClass(i, "dragonBones.FastBoneTimelineState")
}(dragonBones || (dragonBones = {}));
var dragonBones;
!function (t) {
	var i = function () {
		...
		return i.borrowObject = function () {
			...
			if (this._currentTime != e) {
				...
				for (var s, r, o = this._timelineData.frameList, l = 0, h = this._timelineData.frameList.length; h > l; ++l) {
					...
					r = o[this._currentFrameIndex], s && this._slot._arriveAtFrame(s, this._animationState), this._currentFrameDuration = r.duration, this._currentFramePosition = r.position, s = r
				}
				r && (this._slot._arriveAtFrame(r, this._animationState), this._blendEnabled = r.displayIndex >= 0, this._blendEnabled ? this.updateToNextFrame(i) : (this._tweenEasing = NaN, this._tweenColor = !1)), this._blendEnabled && this.updateTween()
			}
		}, a.updateToNextFrame = function (i) {
			void 0 === i && (i = 0);
			var e = this._currentFrameIndex + 1;
			e >= this._timelineData.frameList.length && (e = 0);
			var a = this._timelineData.frameList[this._currentFrameIndex], n = this._timelineData.frameList[e], s = !1;
			if (0 == e && this._animationState.playTimes && this._animationState.currentPlayTimes >= this._animationState.playTimes && ((this._currentFramePosition + this._currentFrameDuration) / this._totalTime + i - this._timelineData.offset) * this._timelineData.scale > .999999 ? (this._tweenEasing = NaN, s = !1) : a.displayIndex < 0 || n.displayIndex < 0 ? (this._tweenEasing = NaN, s = !1) : this._animationState.autoTween ? (this._tweenEasing = this._animationState.animationData.tweenEasing, isNaN(this._tweenEasing) ? (this._tweenEasing = a.tweenEasing, this._tweenCurve = a.curve, isNaN(this._tweenEasing) && null == this._tweenCurve ? s = !1 : (10 == this._tweenEasing && (this._tweenEasing = 0), s = !0)) : s = !0) : (this._tweenEasing = a.tweenEasing, this._tweenCurve = a.curve, !isNaN(this._tweenEasing) && 10 != this._tweenEasing || null != this._tweenCurve ? s = !0 : (this._tweenEasing = NaN, s = !1)), s && (a.color || n.color) ? (t.ColorTransformUtil.minus(n.color || t.ColorTransformUtil.originalColor, a.color || t.ColorTransformUtil.originalColor, this._durationColor), this._tweenColor = 0 != this._durationColor.alphaOffset || 0 != this._durationColor.redOffset || 0 != this._durationColor.greenOffset || 0 != this._durationColor.blueOffset || 0 != this._durationColor.alphaMultiplier || 0 != this._durationColor.redMultiplier || 0 != this._durationColor.greenMultiplier || 0 != this._durationColor.blueMultiplier) : this._tweenColor = !1, !this._tweenColor) {
				var r, o;
				a.color ? (r = a.color, o = !0) : (r = t.ColorTransformUtil.originalColor, o = !1), (this._slot._isColorChanged || o) && (t.ColorTransformUtil.isEqual(this._slot._colorTransform, r) || this._slot._updateDisplayColor(r.alphaOffset, r.redOffset, r.greenOffset, r.blueOffset, r.alphaMultiplier, r.redMultiplier, r.greenMultiplier, r.blueMultiplier, o))
			}
		}, a.updateTween = function () {
			var i = this._timelineData.frameList[this._currentFrameIndex];
			if (this._tweenColor) {
				var e = (this._currentTime - this._currentFramePosition) / this._currentFrameDuration;
				null != this._tweenCurve ? e = this._tweenCurve.getValueByProgress(e) : this._tweenEasing && (e = t.MathUtil.getEaseValue(e, this._tweenEasing)), i.color ? this._slot._updateDisplayColor(i.color.alphaOffset + this._durationColor.alphaOffset * e, i.color.redOffset + this._durationColor.redOffset * e, i.color.greenOffset + this._durationColor.greenOffset * e, i.color.blueOffset + this._durationColor.blueOffset * e, i.color.alphaMultiplier + this._durationColor.alphaMultiplier * e, i.color.redMultiplier + this._durationColor.redMultiplier * e, i.color.greenMultiplier + this._durationColor.greenMultiplier * e, i.color.blueMultiplier + this._durationColor.blueMultiplier * e, !0) : this._slot._updateDisplayColor(this._durationColor.alphaOffset * e, this._durationColor.redOffset * e, this._durationColor.greenOffset * e, this._durationColor.blueOffset * e, this._durationColor.alphaMultiplier * e + 1, this._durationColor.redMultiplier * e + 1, this._durationColor.greenMultiplier * e + 1, this._durationColor.blueMultiplier * e + 1, !0)
			}
		}, a.updateSingleFrame = function () {
			var i = this._timelineData.frameList[0];
			if (this._slot._arriveAtFrame(i, this._animationState), this._isComplete = !0, this._tweenEasing = NaN, this._tweenColor = !1, this._blendEnabled = i.displayIndex >= 0, this._blendEnabled) {
				var e, a;
				i.color ? (e = i.color, a = !0) : (e = t.ColorTransformUtil.originalColor, a = !1), (this._slot._isColorChanged || a) && (t.ColorTransformUtil.isEqual(this._slot._colorTransform, e) || this._slot._updateDisplayColor(e.alphaOffset, e.redOffset, e.greenOffset, e.blueOffset, e.alphaMultiplier, e.redMultiplier, e.greenMultiplier, e.blueMultiplier, a))
			}
		}, i.HALF_PI = .5 * Math.PI, i.DOUBLE_PI = 2 * Math.PI, i._pool = [], i
	}();
	t.FastSlotTimelineState = i, egret.registerClass(i, "dragonBones.FastSlotTimelineState")
}(dragonBones || (dragonBones = {})), function () {
	var t = dragonBones.DataParser, i = dragonBones.TextureData, e = function (t, i, e) {
		this._textureDatas = {}, this.scale = e || 1, this.texture = t, this.name = i.name, this.parseData(i)
	};
	e.rotatedDic = {}, e.prototype = {
		constructor: e, getTexture: function (t) {
			var i = this._textureDatas[t];
			return i && (i.texture = this.texture, i.rotated && (e.rotatedDic[t] = 1)), i
		}, dispose: function () {
			this.texture = null, this._textureDatas = {}
	...
	var i = (180 / Math.PI, dragonBones.TextureAtlas), e = function () {
		t.call(this, this), this._display = null
	};
	__extends(e, t, {
		dispose: function () {
			if (this._displayList)for (var i = this._displayList.length, e = 0; i > e; e++) {
				var a = this._displayList[e];
				a instanceof Armature && a.dispose()
			}
			t.prototype.dispose(), this._display = null
			...
			this._display && t && (i ? t.addChildAt(this._display, i) : t.addChild(this._display))
			...
			this._display && (this._display.position.x = this._global.x, this._display.position.y = this._global.y, this._display.scale.x = this._global.scaleX, this._display.scale.y = this._global.scaleY, this._display.rotation = this._global.skewX)
			...
			t.prototype._updateDisplayColor.call(this, i, e, a, n, s, r, o, l, h), this._display && (this._display.alpha = s)
		}, _updateDisplayBlendMode: function (t) {
		}, _calculateRelativeParentTransform: function () {
			this._global.scaleX = this._origin.scaleX * this._offset.scaleX, this._global.scaleY = this._origin.scaleY * this._offset.scaleY, this._global.skewX = this._origin.skewX + this._offset.skewX, this._global.skewY = this._origin.skewY + this._offset.skewY, this._global.x = this._origin.x + this._offset.x + this._parent._tweenPivot.x, this._global.y = this._origin.y + this._offset.y + this._parent._tweenPivot.y, this._displayDataList && this._currentDisplayIndex >= 0 && this._displayDataList[this._currentDisplayIndex] && 1 == i.rotatedDic[this._displayDataList[this._currentDisplayIndex].name] && (this._global.skewX -= 1.57, this._global.skewY -= 1.57)
		}
	}), dragonBones.PixiSlot = e
}(dragonBones.Slot), function (t) {
	var i = dragonBones.Armature, e = dragonBones.PixiSlot, a = function () {
		t.call(this, this)
	};
	__extends(a, t, {
		_generateArmature: function () {
			var t = new i(new PIXI.Container);
			return t
		}, _generateSlot: function () {
			var t = new e;
			return t
		}, _generateDisplay: function (t, i, e, a) {
			var n = t.getTexture(i), s = n.region;
			this._textureCache = this._textureCache || {}, this._textureCache[t.texture.src] || (this._textureCache[t.texture.src] = new PIXI.BaseTexture(t.texture));
			var r = new PIXI.Texture(this._textureCache[t.texture.src], new PIXI.Rectangle(s.x, s.y, s.width, s.height)), o = new PIXI.Sprite(r);
			if (isNaN(e) || isNaN(a)) {
				var l = t.getFrame(i);
				null != l ? (e = l.width / 2, a = l.height / 2) : (e = n.region.width / 2, a = n.region.height / 2)
			}
			return o.pivot.x = e, o.pivot.y = a, o
		}
	}), dragonBones.PixiFactory = a
